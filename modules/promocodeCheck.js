...
export const defaulPromocode = "BUFFALO65";
...
export const togglePromocodeWrapper = (state) => {
  ...
  if (state === "show") {
    ...
    // которого не запоминал. На мобильном Safari такой откат прилетает уже
    // после pageshow и затирал записанное свойство; с атрибутом откатывать
    // теперь некуда — по умолчанию там тот же код.
