...
if (twoStepFormFourthStep) {
  ...
  // State/Province — свободный ввод (необязательный). Видимость задаёт
  // applyRegionField по стране (см. getRegionMode в data.js).
  ...
  // Apartment — необязательный, НЕ в валидации; State свободным вводом — тоже.
