export const translations = {
  ...
  sw: {
    ...
    footerText: `<span class="current-domain"></span> ni jukwaa la taarifa kuhusu bonasi na promosheni katika kasino mtandaoni. Taarifa zote zilizotolewa ni kwa madhumuni ya taarifa na burudani tu. Masharti na hali za bonasi zinaweza kubadilika bila taarifa ya awali, na <span class="current-domain"></span> haijalishi kwa tofauti zozote. Ofa zinapatikana tu kwa watu wenye umri wa 18+ na wakaazi wa maeneo yanayostahiki. Kabla ya kujisajili au kudai bonasi yoyote, tafadhali soma masharti na hali za kila kasino kwa makini. Cheza kwa uwajibikaji!`,
    // | FORM TRANSLATIONS
    backBtn: "Rudi",
    closeBtn: "Funga",
    // | Step 1
  ...
  rw: {
    ...
    footerText: `<span class="current-domain"></span> ni urubuga rutanga amakuru ku bonus na promosiyo muri kasino zo kuri interineti. Amakuru yose atanzwe ni ku nyungu zo kumenya no kwishimisha gusa. Amategeko na conditions za bonus ashobora guhinduka nta mbere y'igihe, kandi <span class="current-domain"></span> ntishinzwe ibitandukanye. Amatangwa arahari gusa ku bantu bafite imyaka 18+ kandi batuye mu turere twemewe. Mbere yo kwiyandikisha cyangwa gufata bonus iyo ari yo yose, soma neza amategeko n\'ibisabwa bya buri kasino. Kina neza kandi wubahirize amategeko!`,
    // | FORM TRANSLATIONS
  ...
  ar: {
    ...
    footerText: `<span class="current-domain"></span> هو منصة معلوماتية عن المكافآت والعروض في الكازينوهات عبر الإنترنت. جميع المعلومات المقدمة لأغراض إعلامية وترفيهية فقط. قد تتغير شروط وأحكام المكافآت دون إشعار مسبق، و <span class="current-domain"></span> غير مسؤول عن أي اختلافات. العروض متاحة فقط للأشخاص الذين تبلغ أعمارهم 18 سنة فأكثر ويقيمون في المناطق المؤهلة. قبل التسجيل أو المطالبة بأي مكافأة، يرجى قراءة الشروط والأحكام الخاصة بكل كازينو بعناية. العب بمسؤولية!`,
    // | FORM TRANSLATIONS
    backBtn: "عودة",
    closeBtn: "إغلاق",
    // | Step 1
