export const translations = {
  ...
  sw: {
    ...
    footerText: `<span class="current-domain"></span> ni jukwaa la taarifa kuhusu bonasi na matangazo kwenye kasino mtandaoni. Taarifa zote zilizotolewa ni kwa madhumuni ya taarifa na burudani pekee. Masharti na hali za bonasi yanaweza kubadilika bila taarifa ya awali, na <span class="current-domain"></span> haijalishi kwa tofauti yoyote. Ofa zinapatikana kwa watu wazima walio na umri wa miaka 18+ tu na wakaazi wa maeneo yanayoruhusiwa. Kabla ya kusajili au kudai bonasi yoyote, tafadhali soma masharti na hali za kila kasino kwa makini. Cheza kwa uwajibikaji!`,
    // | FORM TRANSLATIONS
    backBtn: "Rudi",
    closeBtn: "Funga",
    // | Step 1
  ...
  rw: {
    ...
    footerText: `<span class="current-domain"></span> ni urubuga rutanga amakuru ku byerekeye bonus na promotions muri kasino zo kuri internet. Amakuru yose atangwa ni ku nyungu z’amakuru no kwidagadura gusa. Amabwiriza na conditions za bonus ashobora guhinduka nta kubimenyesha mbere, kandi <span class="current-domain"></span> ntiyemerewe ibibazo byose. Ibyo byiza biboneka ku bantu bafite imyaka 18+ gusa kandi batuye mu bihugu bemerewe. Mbere yo kwiyandikisha cyangwa gusaba bonus iyo ari yo yose, soma neza amabwiriza na conditions za buri kasino. Koresha mu buryo bw’umwuga!`,
    // | FORM TRANSLATIONS
  ...
  ar: {
    ...
    footerText: `<span class="current-domain"></span> هو منصة معلوماتية حول المكافآت والعروض في الكازينوهات على الإنترنت. جميع المعلومات المقدمة لأغراض إعلامية وترفيهية فقط. قد تتغير شروط وأحكام المكافآت دون إشعار مسبق، و <span class="current-domain"></span> غير مسؤول عن أي اختلافات. العروض متاحة فقط للأفراد البالغين 18 عامًا فأكثر والمقيمين في الولايات القضائية المؤهلة. قبل التسجيل أو المطالبة بأي مكافأة، يرجى قراءة الشروط والأحكام لكل كازينو بعناية. العب بمسؤولية!`,
    // | FORM TRANSLATIONS
    backBtn: "رجوع",
    closeBtn: "إغلاق",
    // | Step 1
