export const translations = {
  ...
  de: {
    ...
    footerText: `<span class="current-domain"></span> ist eine Informationsplattform über Boni und Aktionen in Online-Casinos. Alle bereitgestellten Informationen dienen nur zu Informations- und Unterhaltungszwecken. Bonusbedingungen können sich ohne Vorankündigung ändern, und <span class="current-domain"></span> übernimmt keine Verantwortung für Abweichungen. Angebote sind nur für Personen ab 18 Jahren verfügbar, die in berechtigten Rechtsgebieten ansässig sind. Bitte lesen Sie vor der Registrierung oder der Inanspruchnahme eines Bonus die Bedingungen jedes Casinos sorgfältig. Spielen Sie verantwortungsbewusst!`,
    // | FORM TRANSLATIONS
    backBtn: "Zurück",
    closeBtn: "Schließen",
    // | Step 1
  ...
  ua: {
    ...
    footerText: `<span class="current-domain"></span> є інформаційною платформою про бонуси та акції в онлайн-казино. Вся надана інформація має виключно ознайомчий та розважальний характер. Умови бонусів можуть змінюватися без попереднього повідомлення, і <span class="current-domain"></span> не несе відповідальності за можливі невідповідності. Пропозиції доступні лише для осіб віком від 18 років і старше, які є мешканцями дозволених юрисдикцій. Перед реєстрацією або отриманням будь-якого бонусу уважно ознайомтеся з умовами та положеннями кожного казино. Грайте відповідально!`,
    // | FORM TRANSLATIONS
    backBtn: "Назад",
    closeBtn: "Закрити",
    // | Step 1
  ...
  it: {
    ...
    footerText: `<span class="current-domain"></span> è una piattaforma informativa sui bonus e promozioni nei casinò online. Tutte le informazioni fornite hanno scopo esclusivamente informativo e di intrattenimento. I termini e le condizioni dei bonus possono cambiare senza preavviso e <span class="current-domain"></span> non è responsabile per eventuali discrepanze. Le offerte sono disponibili solo per individui di età pari o superiore a 18 anni e residenti in giurisdizioni idonee. Prima di registrarti o richiedere qualsiasi bonus, leggi attentamente i termini e le condizioni di ciascun casinò. Gioca responsabilmente!`,
    // | FORM TRANSLATIONS
    backBtn: "Indietro",
    closeBtn: "Chiudi",
    // | Step 1
  ...
  az: {
    ...
    heroTitle: `bonusunuzu tələb edin <br/> <span>100 pulsuz fırlanma</span> <br/> <span>monkey heist</span> oyununda`,
  ...
  ee: {
    ...
    footerText: `<span class="current-domain"></span> on veebiplatvorm, mis pakub teavet online kasiinode boonuste ja kampaaniate kohta. Kõik esitatud andmed on ainult informatiivsed ja meelelahutuslikud. Boonuste tingimused võivad muutuda ilma eelneva teavituseta ja <span class="current-domain"></span> ei vastuta võimalike erinevuste eest. Pakkumised on saadaval ainult vähemalt 18-aastastele ja õigustatud jurisdiktsioonides elavatele isikutele. Enne registreerumist või boonuse nõudmist lugege hoolikalt iga kasiino tingimusi. Mängige vastutustundlikult!`,
    // | FORM TRANSLATIONS
    backBtn: "Tagasi",
    closeBtn: "Sulge",
    // | Step 1
  ...
  lv: {
    ...
    footerText: `<span class="current-domain"></span> ir informatīvs platforma par tiešsaistes kazino bonusiem un akcijām. Visa sniegtā informācija ir tikai informatīva un izklaidējoša. Bonusu noteikumi var mainīties bez iepriekšēja brīdinājuma, un <span class="current-domain"></span> nav atbildīgs par jebkādām neatbilstībām. Piedāvājumi ir pieejami tikai personām, kas ir vecākas par 18 gadiem un dzīvo atbilstošās jurisdikcijās. Pirms reģistrēšanās vai bonusa pieprasīšanas, lūdzu, rūpīgi izlasiet katra kazino noteikumus. Spēlējiet atbildīgi!`,
    // | FORM TRANSLATIONS
    backBtn: "Atpakaļ",
    closeBtn: "Aizvērt",
    // | Step 1
  ...
  lt: {
    ...
    footerText: `<span class="current-domain"></span> yra informacinė platforma apie internetinių kazino premijas ir akcijas. Visa pateikta informacija yra tik informacinė ir pramoginė. Premijų sąlygos gali keistis be išankstinio įspėjimo, ir <span class="current-domain"></span> neatsako už jokius neatitikimus. Pasiūlymai galioja tik asmenims, vyresniems nei 18 metų ir gyvenantiems tinkamose jurisdikcijose. Prieš registruodamiesi ar reikalaujant premijos, atidžiai perskaitykite kiekvieno kazino taisykles. Žaiskite atsakingai!`,
    // | FORM TRANSLATIONS
    backBtn: "Atgal",
    closeBtn: "Uždaryti",
    // | Step 1
  ...
  hr: {
    ...
    footerText: `<span class="current-domain"></span> je informativna platforma o bonusima i promocijama u online kockarnicama. Sve pružene informacije služe isključivo u informativne i zabavne svrhe. Uvjeti bonusa mogu se promijeniti bez prethodne najave, a <span class="current-domain"></span> nije odgovoran za eventualne razlike. Ponude su dostupne samo osobama starijima od 18 godina i rezidentima ovlaštenih jurisdikcija. Prije registracije ili zahtjeva za bonus, pažljivo pročitajte uvjete svake kockarnice. Igrajte odgovorno!`,
    // | FORM TRANSLATIONS
    backBtn: "Natrag",
    closeBtn: "Zatvori",
    // | Step 1
