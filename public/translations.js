export const translations = {
  ...
  de: {
    ...
    heroTitle: `Lösen Sie Ihren Bonus ein <br/> <span>333 Freispiele</span> <br/> im <span>Bison Storm</span>`,
    ...
    slideStep2Text:
      'Finden Sie Ihren Bonus im "Bonus-Center" und aktivieren Sie ihn, um zu spielen.',
    slideStep3Title: "Spielen",
    slideStep3Text: "Das Geld ist jetzt zum Spielen verfügbar. Viel Spaß!",
    footerText: `<span class="current-domain"></span> ist eine Informationsplattform über Boni und Aktionen in Online-Casinos. Alle bereitgestellten Informationen dienen nur zu Informations- und Unterhaltungszwecken. Die Bonusbedingungen können sich ohne vorherige Ankündigung ändern, und <span class="current-domain"></span> übernimmt keine Verantwortung für Abweichungen. Die Angebote sind nur für Personen ab 18 Jahren verfügbar, die in berechtigten Jurisdiktionen ansässig sind. Lesen Sie vor der Registrierung oder Einlösung eines Bonus stets die Bedingungen jedes Casinos. Spielen Sie verantwortungsbewusst!`,
    ...
    cryptoBonus: "Satoshi-Bonus",
    cryptoBonusText: "150% bei Einzahlungen mit Kryptowährungen",
    highRollerBonus: "High-Roller-Bonus",
