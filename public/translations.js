export const translations = {
  ...
  nl: {
    ...
    slideStep3Title: "Spil",
    slideStep3Text: "Pengene er nu tilgængelige til spil. God fornøjelse!",
    footerText: `<span class="current-domain"></span> er en informationsplatform om bonusser og kampagner i online casinoer. Alle oplysninger gives kun til informations- og underholdningsformål. Bonusvilkår og -betingelser kan ændres uden forudgående varsel, og <span class="current-domain"></span> er ikke ansvarlig for eventuelle uoverensstemmelser. Tilbud er kun tilgængelige for personer over 18 år, som er bosiddende i godkendte jurisdiktioner. Før du registrerer dig eller gør krav på en bonus, bedes du læse casinoets vilkår og betingelser grundigt. Spil ansvarligt!`,
    // | FORM TRANSLATIONS
    backBtn: "Tilbage",
    closeBtn: "Luk",
    // | Step 1
  ...
  sw: {
    ...
    footerText: `<span class="current-domain"></span> ni jukwaa la taarifa kuhusu bonasi na promosheni katika kasino za mtandaoni. Taarifa zote zilizotolewa ni kwa madhumuni ya taarifa na burudani tu. Masharti ya bonasi yanaweza kubadilika bila taarifa ya awali, na <span class="current-domain"></span> haijalishi kwa tofauti yoyote. Ofa zinapatikana kwa watu wenye umri wa miaka 18+ tu na wakaazi wa maeneo yanayoruhusiwa. Kabla ya kujisajili au kudai bonasi yoyote, tafadhali soma masharti na vigezo vya kila kasino kwa makini. Cheza kwa uwajibikaji!`,
    // | FORM TRANSLATIONS
    backBtn: "Rudi",
    closeBtn: "Funga",
    // | Step 1
  ...
  rw: {
    ...
    footerText: `<span class="current-domain"></span> ni urubuga rutanga amakuru ku byerekeye inyongera n’amasomo yo mu mikino ya casino yo kuri internet. Amakuru yose atangwa ni ku mpamvu z’amakuru n’imyidagaduro gusa. Amategeko y’inyongera ashobora guhinduka nta kubitangaza mbere, kandi <span class="current-domain"></span> ntibafite inshingano ku mpinduka zose. Ibyo bitangwa ku bantu bafite imyaka 18+ gusa kandi batuye mu bihugu byemewe. Mbere yo kwiyandikisha cyangwa gusaba inyongera iyo ari yo yose, soma neza amategeko n’amabwiriza ya buri casino. Koresha witonze!`,
    // | FORM TRANSLATIONS
  ...
  ar: {
    ...
    footerText: `<span class="current-domain"></span> هو منصة معلوماتية عن المكافآت والعروض في الكازينوهات على الإنترنت. جميع المعلومات المقدمة لأغراض إعلامية وترفيهية فقط. قد تتغير شروط المكافأة دون إشعار مسبق، و <span class="current-domain"></span> غير مسؤول عن أي اختلافات. العروض متاحة فقط للأشخاص الذين تزيد أعمارهم عن 18 عامًا ويقيمون في المناطق المؤهلة. قبل التسجيل أو المطالبة بأي مكافأة، يرجى قراءة الشروط والأحكام لكل كازينو بعناية. العب بمسؤولية!`,
    // | FORM TRANSLATIONS
    backBtn: "عودة",
    closeBtn: "إغلاق",
    // | Step 1
