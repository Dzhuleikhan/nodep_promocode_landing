export const translations = {
  ...
  az: {
    ...
    heroTitle: `bonusunuzu tələb edin <br/> <span><i class="actual-spin-amount">100</i> pulsuz fırlanma</span> <br/> <span>the dog house</span> oyununda`,
    heroSubtitle: `+<span class="two-step-bonus-percent"></span> qədər <span class='bonus-total-amount'></span> <span class='bonus-currency-symbol'></span> & <span class="actual-spin-amount"></span>FS pulsuz fırlanma ilk depozitinizlə`,
    heroBtn: "bonus alın",
  ...
  ee: {
    ...
    footerText: `<span class="current-domain"></span> on informatiivne platvorm boonuste ja kampaaniate kohta online kasiinodes. Kõik esitatud andmed on ainult informatiivse ja meelelahutusliku eesmärgiga. Boonuste tingimused võivad muutuda ette teatamata ja <span class="current-domain"></span> ei vastuta võimalike erinevuste eest. Pakkumised on saadaval ainult 18-aastastele ja õigustatud jurisdiktsioonides elavatele isikutele. Enne registreerimist või boonuse nõudmist lugege hoolikalt iga kasiino tingimusi. Mängige vastutustundlikult!`,
    // | FORM TRANSLATIONS
    backBtn: "Tagasi",
    closeBtn: "Sulge",
    // | Step 1
  ...
  lv: {
    ...
    footerText: `<span class="current-domain"></span> ir informatīva platforma par bonusiem un akcijām tiešsaistes kazino. Visa sniegtā informācija ir tikai informatīva un izklaidējoša. Bonusu noteikumi var tikt mainīti bez iepriekšēja brīdinājuma, un <span class="current-domain"></span> neatbild par iespējamiem neatbilstības gadījumiem. Piedāvājumi ir pieejami tikai personām, kas vecākas par 18 gadiem un dzīvo piemērotās jurisdikcijās. Pirms reģistrēšanās vai bonusa pieprasīšanas rūpīgi izlasiet katra kazino noteikumus. Spēlējiet atbildīgi!`,
    // | FORM TRANSLATIONS
    backBtn: "Atpakaļ",
    closeBtn: "Aizvērt",
    // | Step 1
  ...
  lt: {
    ...
    footerText: `<span class="current-domain"></span> yra informacinė platforma apie premijas ir akcijas internetiniuose kazino. Visa pateikta informacija yra tik informacinio ir pramoginio pobūdžio. Premijų sąlygos gali keistis be išankstinio įspėjimo, o <span class="current-domain"></span> neatsako už galimus neatitikimus. Pasiūlymai galioja tik asmenims, vyresniems nei 18 metų, gyvenantiems tinkamose jurisdikcijose. Prieš registruodamiesi arba prašydami premijos, atidžiai perskaitykite kiekvieno kazino taisykles. Žaiskite atsakingai!`,
    // | FORM TRANSLATIONS
    backBtn: "Atgal",
    closeBtn: "Uždaryti",
    // | Step 1
  ...
  hr: {
    ...
    footerText: `<span class="current-domain"></span> je informativna platforma o bonusima i promocijama u online kockarnicama. Sve pružene informacije su samo u informativne i zabavne svrhe. Uvjeti bonusa mogu se promijeniti bez prethodne najave, a <span class="current-domain"></span> ne odgovara za moguće nesuglasice. Ponude su dostupne samo osobama starijim od 18 godina koje su stanovnici nadležnih jurisdikcija. Prije registracije ili preuzimanja bonusa, pažljivo pročitajte uvjete svake kockarnice. Igrajte odgovorno!`,
    // | FORM TRANSLATIONS
    backBtn: "Natrag",
    closeBtn: "Zatvori",
    // | Step 1
  ...
  uz: {
    ...
    heroTitle: `bonusingizni oling <br/> <span><i class="actual-spin-amount">100</i> bepul aylantirish</span> <br/> <span>the dog house</span> o‘yinida`,
    heroSubtitle: `+<span class="two-step-bonus-percent"></span> gacha <span class='bonus-total-amount'></span> <span class='bonus-currency-symbol'></span> & <span class="actual-spin-amount"></span>FS Bepul Aylantirish 1-chi depozit bilan`,
    heroBtn: "bonusni olish",
    slideStep1Title: "Ro‘yxatdan o‘tish",
    slideStep1Text:
      '"Bonusni olish" tugmasini bosing va bepul ro‘yxatdan o‘ting.',
    slideStep2Title: "Bonusni faollashtirish",
    slideStep2Text:
      '"Bonus markazi"dan bonusingizni toping va o‘ynashni boshlash uchun uni faollashtiring.',
    slideStep3Title: "O‘ynash",
    slideStep3Text: "Pul endi o‘yinda ishlatishga tayyor. Marhamat!",
    footerText: `<span class="current-domain"></span> onlayn kazinolardagi bonuslar va aksiyalar haqida ma’lumot platformasidir. Barcha ma’lumot faqatgina ma’lumot va ko‘ngilochar maqsadlarda taqdim etiladi. Bonus shartlari oldindan ogohlantirishsiz o‘zgarishi mumkin, va <span class="current-domain"></span> hech qanday nomuvofiqlik uchun javobgar emas. Takliflar faqat 18 yosh va undan katta bo‘lgan, mos yurisdiktsiyada istiqomat qiluvchi shaxslarga taqdim etiladi. Ro‘yxatdan o‘tish yoki bonusni olishdan oldin, har bir kazino shartlarini diqqat bilan o‘qing. Mas’uliyat bilan o‘ynang!`,
    // | FORM TRANSLATIONS
    backBtn: "Ortga",
    closeBtn: "Yopish",
    // | Step 1
    ...
    // | Decline
    areYouSure: `Ishonchingiz komilmi? <br /> Jarayon yo‘qoladi`,
    keepRegistering: "Ro‘yxatdan o‘tishni davom etish",
    returnToWebsite: "Vebsaytga qaytish",
  },
  kz: {
    pageTitle: "🎁 Сыйлығыңыз дайын - Goldbet",
    heroTitle: `сыйлығыңызды алыңыз <br/> <span><i class="actual-spin-amount">100</i> тегін айналдыру</span> <br/> <span>the dog house</span> ойынында`,
    heroSubtitle: `+<span class="two-step-bonus-percent"></span> дейін <span class='bonus-total-amount'></span> <span class='bonus-currency-symbol'></span> & <span class="actual-spin-amount"></span>FS Тегін Айналдыру 1-ші депозитпен`,
    heroBtn: "сыйлықты алу",
    slideStep1Title: "Тіркелу",
    slideStep1Text: '"Сыйлықты алу" батырмасын басып, тегін тіркеліңіз.',
    slideStep2Title: "Сыйлықты белсендіру",
    slideStep2Text:
      '"Сыйлық орталығынан" сыйлығыңызды тауып, ойнауды бастау үшін оны белсендіріңіз.',
    slideStep3Title: "Ойнау",
    slideStep3Text: "Ақша енді ойынға қолжетімді. Ләззат алыңыз!",
    footerText: `<span class="current-domain"></span> онлайн казинолардағы сыйлықтар мен акциялар туралы ақпараттық платформа болып табылады. Барлық ақпарат тек ақпараттық және ойын-сауық мақсаттарында ұсынылған. Сыйлық шарттары алдын ала ескертусіз өзгеруі мүмкін, және <span class="current-domain"></span> ешқандай сәйкессіздік үшін жауапты емес. Ұсыныстар тек 18 жастан асқан және қолайлы юрисдикцияда тұратын тұлғаларға қолжетімді. Тіркелмес бұрын немесе сыйлықты алар алдында әрбір казинодағы шарттарды мұқият оқыңыз. Жауапкершілікпен ойнаңыз!`,
    // | FORM TRANSLATIONS
    backBtn: "Артқа",
    closeBtn: "Жабу",
    // | Step 1
    depToBalance: `<span><i class="actual-spin-amount">100</i> ТЕГІН АЙНАЛДЫРУ</span>`,
    withoutDeposit: "Депозитсіз",
    step1Title: "Сыйлығыңызды таңдаңыз",
    welcomeBonus: "Қош келдіңіз сыйлығы",
    welcomeBonusText: "Алғашқы депозитіңізде",
    cryptoBonus: "Satoshi Сыйлығы",
    cryptoBonusText: "Крипто депозиттеріне 150%",
    highRollerBonus: "High Roller Сыйлығы",
    highRollerBonusText: "$500-ден асқан депозиттерге 250%",
    withoutBonus: "Сыйлықсыз",
    withoutBonusText: "Сіз сыйлық алмайсыз",
    iHavePromoCode: "Менде Промо-код бар",
    promoCodePlaceHolder: "Промо Код",
    promoCodeApplyBtn: "Қолдану",
    continueBtn: "Жалғастыру",
    // | Step 2
    step2Title: "E-mail енгізіңіз",
    emailPlaceholder: "E-mail енгізіңіз",
    passwordPlaceholder: "Құпиясөз енгізіңіз",
    // | Step 3
    step3Title: "Сіздің атыңыз кім?",
    namePlaceholder: "Атыңызды енгізіңіз",
    lastNamePlaceholder: "Тегіңізді енгізіңіз",
    birthdayPlaceholder: "Туған күніңізді таңдаңыз",
    age18Alert: "Жасыңыз 18+ болуы керек",
    ...
    statePlaceholder: "Өңірді таңдаңыз",
    zipCodePlaceholder: "Пошта индексін енгізіңіз",
    createAccountBtn: "Есепшот ашу",
    // | Decline
    areYouSure: `Сіз сенімдісіз бе? <br /> Жазылу процесі жойылады`,
    keepRegistering: "Тіркелуді жалғастыру",
    returnToWebsite: "Вебсайтқа қайту",
  },
  dk: {
    ...
    footerText: `<span class="current-domain"></span> er en informationsplatform om bonusser og kampagner i onlinekasinoer. Alle oplysninger gives udelukkende til informations- og underholdningsformål. Bonusvilkår kan ændres uden forudgående varsel, og <span class="current-domain"></span> er ikke ansvarlig for eventuelle uoverensstemmelser. Tilbud er kun tilgængelige for personer over 18 år, der er bosiddende i berettigede jurisdiktioner. Læs venligst altid kasinoets vilkår og betingelser, før du registrerer dig eller gør krav på en bonus. Spil ansvarligt!`,
    // | FORM TRANSLATIONS
    backBtn: "Tilbage",
    closeBtn: "Luk",
    // | Step 1
    ...
    footerText: `<span class="current-domain"></span> on verkkokasinoiden bonuksia ja kampanjoita koskeva tietosivusto. Kaikki tiedot on tarkoitettu vain informatiivisiin ja viihteellisiin tarkoituksiin. Bonusehdot voivat muuttua ilman ennakkoilmoitusta, eikä <span class="current-domain"></span> ole vastuussa mahdollisista eroavaisuuksista. Tarjoukset ovat saatavilla vain yli 18-vuotiaille henkilöille, jotka asuvat sallituilla alueilla. Lue aina kasinon käyttöehdot huolellisesti ennen rekisteröitymistä tai bonuksen lunastamista. Pelaa vastuullisesti!`,
    // | FORM TRANSLATIONS
    backBtn: "Takaisin",
    closeBtn: "Sulje",
    // | Step 1
  ...
  bg: {
    ...
    footerText: `<span class="current-domain"></span> е информационна платформа за бонуси и промоции в онлайн казина. Цялата предоставена информация е само с информационна и развлекателна цел. Условията за бонусите могат да се променят без предварително уведомление, а <span class="current-domain"></span> не носи отговорност за евентуални несъответствия. Офертите са достъпни само за лица на възраст 18+ и жители на допустими юрисдикции. Преди регистрация или заявяване на бонус, моля, прочетете внимателно условията на всяко казино. Играйте отговорно!`,
    // | FORM TRANSLATIONS
    backBtn: "Назад",
    closeBtn: "Затвори",
    // | Step 1
