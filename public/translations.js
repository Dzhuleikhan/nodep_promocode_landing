export const translations = {
  ...
  az: {
    ...
    heroTitle: `bonusunuzu əldə edin <br/> <span>100 pulsuz fırlanma</span> <br/> <span>royal joker</span> oyununda`,
    heroSubtitle: `Xoş gəlmisiniz bonusunu <span>aktivləşdirin</span> və ilk depozitinizdə <span>100% + 200 FS</span> qazanın.`,
    heroBtn: "bonusu əldə et",
    slideStep1Title: "Qeydiyyat",
    slideStep1Text:
      '"Get Bonus" düyməsini klikləyin və pulsuz qeydiyyatı tamamlayın.',
    slideStep2Title: "Bonusu aktivləşdir",
    slideStep2Text:
      'Bonusunuzu "Bonus Mərkəzi"ndə tapın və oyun oynamağa başlamaq üçün aktivləşdirin.',
    slideStep3Title: "Oyna",
    slideStep3Text: "Pul artıq oyun üçün mövcuddur. Zövq alın!",
    footerText: `<span class="current-domain"></span> onlayn kazinolardakı bonuslar və aksiyalar haqqında məlumat platformasıdır. Bütün məlumatlar yalnız informasiya və əyləncə məqsədilə təqdim olunur. Bonus şərtləri xəbərdarlıq edilmədən dəyişə bilər və <span class="current-domain"></span> hər hansı uyğunsuzluqlara görə məsuliyyət daşımır. Təkliflər yalnız 18 yaşdan yuxarı və uyğun yurisdiksiyaların sakinləri üçün mövcuddur. Qeydiyyatdan keçməzdən və ya hər hansı bonusu tələb etməzdən əvvəl hər kazinonun şərtlərini diqqətlə oxuyun. Cavabdeh şəkildə oynayın!`,
    // | FORM TRANSLATIONS
    backBtn: "Geri",
    closeBtn: "Bağla",
    // | Step 1
    ...
    welcomeBonusText: `İlk depozitinizdə <span class='two-step-welcome-amount'>120,000</span> <span class='two-step-welcome-symbol'></span> qədər + <span class='two-step-bonus-spins'></span>`,
    cryptoBonus: "Satoshi Bonusu",
    cryptoBonusText: "Kripto Depozitlərdə 150%",
    highRollerBonus: "High Roller Bonusu",
    highRollerBonusText: `Depozitlərdə 200% <span class='bonus-highroller-amount'></span> üzərində <span class='two-step-welcome-symbol'></span>`,
