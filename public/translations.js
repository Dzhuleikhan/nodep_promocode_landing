export const translations = {
  ...
  uk: {
    ...
    heroTitle: `отримай свій бонус <br/> <span><i class="actual-spin-amount">100</i> безкоштовних спінів</span> <br/> у <span>big bass splash</span>`,
    ...
    // | Step 2
    step2Title: "Введіть свою електронну адресу",
  ...
  sw: {
    ...
    slideStep2Text:
      'Pata bonasi yako katika "Kituo cha Bonasi" na uwashe ili kuanza kucheza.',
    slideStep3Title: "Cheza",
    slideStep3Text: "Pesa sasa zipo kwa ajili ya mchezo. Furahia!",
    footerText:
    ...
    closeBtn: "Funga",
    // | Step 1
    depToBalance: `<span><i class="actual-spin-amount">100</i> Mizunguko ya Bure</span>`,
    ...
    cryptoBonusText: "150% kwa Amanani za Crypto",
    highRollerBonus: "Bonasi ya High Roller",
    highRollerBonusText: "250% kwa Amanani Zaidi ya $500",
  ...
  rw: {
    ...
    slideStep2Title: "Shyira mu bikorwa bonus",
    slideStep2Text:
      'Shaka bonus yawe muri "Ikigo cya Bonus" hanyuma uyishyire mu bikorwa kugira ngo utangire gukina.',
    slideStep3Title: "Kina",
    slideStep3Text: "Amafaranga ubu arahari ku mukino. Ishimire!",
    footerText:
    ...
    welcomeBonusText: "ku depositi yawe ya mbere",
    cryptoBonus: "Bonus ya Satoshi",
    cryptoBonusText: "150% ku Madorari ya Crypto",
    highRollerBonus: "Bonus ya High Roller",
    highRollerBonusText: "250% ku Deposit irenze $500",
    withoutBonus: "Nta Bonus",
    withoutBonusText: "Ntakindi bonus uzabona",
    ...
    // | Step 3
    step3Title: "Izina ryawe n’irihe?",
    ...
    // | Decline
    areYouSure: `Uriyemeje? <br /> Ibyagezweho bizatakara`,
  ...
  ar: {
    ...
    slideStep2Text: 'ابحث عن مكافأتك في "مركز المكافآت" وفعلها للبدء في اللعب.',
    ...
    withoutBonusText: "لن تتلقى أي مكافأة",
  ...
  lm: {
    ...
    heroTitle: `funa bonus yo <br/> <span><i class="actual-spin-amount">100</i> spins za bwereere</span> <br/> mu <span>big bass splash</span>`,
  ...
  ha: {
    ...
    heroTitle: `karɓi kyautarka <br/> <span><i class="actual-spin-amount">100</i> juyawa kyauta</span> <br/> a cikin <span>big bass splash</span>`,
  ...
  yo: {
    ...
    heroTitle: `gba ẹ̀bùn rẹ <br/> <span><i class="actual-spin-amount">100</i> yíyí ọfẹ</span> <br/> ninu <span>big bass splash</span>`,
  ...
  ig: {
    ...
    heroTitle: `nata onyinye gị <br/> <span><i class="actual-spin-amount">100</i> ntụgharị efu</span> <br/> na <span>big bass splash</span>`,
  ...
  tw: {
    ...
    heroTitle: `gye wo bonasi <br/> <span><i class="actual-spin-amount">100</i> free spins</span> <br/> wɔ <span>big bass splash</span> mu`,
