export const translations = {
  ...
  lm: {
    pageTitle: "🎁 Bonasi yo yeetegefu - Goldbet",
    ...
    slideStep2Text:
      'Funa bonasi yo mu "Ekitundu kya Bonasi" era ogikole otandike okuzannya.',
    slideStep3Title: "Zannya",
    slideStep3Text: "Ensimbizo kati ziriwo okukozesebwa mu muzannyo. Nyumirwa!",
    footerText:
      "Ebirimu byonna ku mukutu guno biweereddwa ku lw’okutunda n’okumanyisa byokka. Tebigenderera kubeera magezi ga by’obukugu, amateeka, eby’ensimbi, eby’obujjanjabi oba obw’engeri endala yonna. Tetukola bisuubizo oba okweyimiriza kwonna ku butuufu, okujjuvu oba okusaanira kw’amawulire gano. Okukozesa kwonna kw’ogassa ku birimu bino kubeera ku bulabe bwo wekka. Omukutu tegubaako buvunaanyizibwa ku kufiirwa oba okwonoonerwa kwonna okubeera olw’okukozesa omukutu guno oba ebirimu byagwo.",
    // | FORM TRANSLATIONS
    backBtn: "Ddayo",
    closeBtn: "Ggalawo",
    // | Step 1
    depToBalance: `<span><i class="actual-spin-amount">100</i> OKUZUNGULA OKW’OBWEREERE</span>`,
    withoutDeposit: "Awatali kuteekamu ssente",
    step1Title: "Londa Bonasi Yo",
    welcomeBonus: "Bonasi ey’okwaniriza",
    welcomeBonusText: "ku kuteekamu ssente kwo okusooka",
    cryptoBonus: "Bonasi ya Satoshi",
    cryptoBonusText: "150% ku kuteekamu ssente za Crypto",
    highRollerBonus: "Bonasi ya High Roller",
    highRollerBonusText: "250% ku kuteekamu ssente ezisukka ku $500",
    ...
    step2TitlePhone: "Yingiza Ennamba Yo Essimu",
    emailPlaceholder: "Yingiza E-mail",
    passwordPlaceholder: "Yingiza Ekigambo ky’Ekyama",
    // | Step 3
    step3Title: "Erinnya Lyo Lye Ani?",
    namePlaceholder: "Yingiza Erinnya",
    lastNamePlaceholder: "Yingiza Erinnya ly’Eky’obusika",
    birthdayPlaceholder: "Londa Olunaku lw’Okuzzaalibwa",
    age18Alert: "Emyaka girina okuba 18+",
    invalidDate: "Olunaku si lutufu",
    male: "Omusajja",
    female: "Omukazi",
    finalStepBtn: "Eddaala erisembayo",
    // | Step 4
    ...
    // | Decline
    areYouSure: `Okakasa? <br /> Enkola yo egenda kubula`,
    keepRegistering: "Weyongere okuwandiika",
  ...
  am: {
    ...
    slideStep2Text: "ቦነስዎን በ “የቦነስ ማዕከል” ውስጥ ይፈልጉ እና ለመጫወት እንዲጀምሩ ያንቁት።",
    slideStep3Title: "ይጫወቱ",
    slideStep3Text: "ገንዘቡ አሁን ለጨዋታ ዝግጁ ነው። ይደሰቱ!",
    footerText:
      "በዚህ ድር ጣቢያ ላይ ያሉ ሁሉም ይዘቶች ለማስታወቂያ እና ለመረጃ ብቻ ይሰጣሉ። ይህ ማንኛውንም የሙያ፣ የህግ፣ የፋይናንስ፣ የሕክምና ወይም ሌላ አይነት ምክር አይሆንም። ስለ መረጃው ትክክለኛነት፣ ሙሉነት ወይም ተስማሚነት ምንም አይነት ዋስትና አንሰጥም። በዚህ ይዘት ላይ የሚያደርጉት ማንኛውም እምነት በሙሉ በራስዎ አደጋ ነው። ድር ጣቢያው ከዚህ ጣቢያ ወይም ከይዘቱ መጠቀም የተነሳ ለሚከሰት ማንኛውም ኪሳራ ወይም ጉዳት ምንም ኃላፊነት አይወስድም።",
    // | FORM TRANSLATIONS
    backBtn: "ተመለስ",
    closeBtn: "ዝጋ",
    // | Step 1
    ...
    withoutBonus: "ያለ ቦነስ",
    withoutBonusText: "ምንም ቦነስ አትቀበሉም",
    ...
    step2TitlePhone: "የስልክ ቁጥርዎን ያስገቡ",
    emailPlaceholder: "ኢ-ሜይል ያስገቡ",
