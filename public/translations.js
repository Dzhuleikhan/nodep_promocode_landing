export const translations = {
  ...
  uk: {
    ...
    slideStep2Title: "Активувати бонус",
    slideStep2Text:
      'Знайдіть свій бонус у "Бонус-центрі" та активуйте його, щоб почати грати.',
    slideStep3Title: "Грайте",
    slideStep3Text: "Гроші тепер доступні для гри. Насолоджуйтесь!",
    footerText:
      "Весь вміст цього вебсайту надається виключно з маркетинговою та інформаційною метою. Він не є професійною, юридичною, фінансовою, медичною чи будь-якою іншою порадою. Ми не надаємо жодних запевнень чи гарантій щодо точності, повноти або придатності інформації. Будь-яка довіра, яку ви покладаєте на цей вміст, здійснюється виключно на ваш власний ризик. Сайт не несе жодної відповідальності за будь-які втрати чи збитки, понесені внаслідок використання цього вебсайту або його матеріалів.",
    // | FORM TRANSLATIONS
    backBtn: "Назад",
    closeBtn: "Закрити",
    // | Step 1
    ...
    cryptoBonus: "Бонус Сатоші",
    cryptoBonusText: "150% на криптодепозити",
    highRollerBonus: "Бонус Хай-Роллер",
  ...
  zh: {
    ...
    slideStep2Text: '在"奖金中心"找到您的奖金并激活即可开始游戏。',
    slideStep3Title: "游戏",
    slideStep3Text: "资金现已可用于游戏。尽情享受吧！",
    footerText:
      "本网站所有内容仅供营销和信息参考之用，不构成专业、法律、财务、医疗或任何其他类型的建议。我们对信息的准确性、完整性或适用性不作任何形式的陈述或保证。您对本内容的任何依赖完全由您自行承担风险。对于因使用本网站或其材料而造成的任何损失或损害，本网站概不负责。",
    // | FORM TRANSLATIONS
    backBtn: "返回",
    closeBtn: "关闭",
    // | Step 1
  ...
  bn: {
    ...
    slideStep1Text:
      '"বোনাস নিন" ক্লিক করুন এবং বিনামূল্যে নিবন্ধন সম্পন্ন করুন।',
    slideStep2Title: "বোনাস সক্রিয় করুন",
    slideStep2Text:
      '"বোনাস সেন্টার"-এ আপনার বোনাস খুঁজুন এবং খেলা শুরু করতে এটি সক্রিয় করুন।',
    slideStep3Title: "খেলুন",
    slideStep3Text: "টাকা এখন খেলার জন্য উপলব্ধ। উপভোগ করুন!",
    footerText:
      "এই ওয়েবসাইটের সমস্ত বিষয়বস্তু শুধুমাত্র বিপণন এবং তথ্যগত উদ্দেশ্যে সরবরাহ করা হয়েছে। এটি পেশাদার, আইনি, আর্থিক, চিকিৎসা বা অন্য কোনো ধরনের পরামর্শ গঠন করে না। তথ্যের নির্ভুলতা, সম্পূর্ণতা বা উপযুক্ততা সম্পর্কে আমরা কোনো ধরনের উপস্থাপনা বা ওয়ারেন্টি দিই না। এই বিষয়বস্তুর উপর আপনার যেকোনো নির্ভরতা সম্পূর্ণরূপে আপনার নিজের ঝুঁকিতে। এই ওয়েবসাইট বা এর উপকরণ ব্যবহারের ফলে সৃষ্ট কোনো ক্ষতি বা লোকসানের জন্য সাইট কোনো দায়বদ্ধতা গ্রহণ করে না।",
    // | FORM TRANSLATIONS
    backBtn: "ফিরে যান",
    closeBtn: "বন্ধ করুন",
    // | Step 1
    depToBalance: `<span>১০০ ফ্রি স্পিন</span>`,
    withoutDeposit: "জমা ছাড়া",
    step1Title: "আপনার বোনাস বেছে নিন",
    welcomeBonus: "স্বাগত বোনাস",
    welcomeBonusText: "আপনার প্রথম জমার উপর",
    cryptoBonus: "সাতোশি বোনাস",
    cryptoBonusText: "ক্রিপ্টো জমার উপর ১৫০%",
    highRollerBonus: "হাই রোলার বোনাস",
    highRollerBonusText: "$৫০০-এর বেশি জমার উপর ২৫০%",
    withoutBonus: "বোনাস ছাড়া",
    withoutBonusText: "আপনি কোনো বোনাস পাবেন না",
    iHavePromoCode: "আমার একটি প্রোমো-কোড আছে",
    promoCodePlaceHolder: "প্রোমো কোড",
    promoCodeApplyBtn: "প্রয়োগ করুন",
    continueBtn: "চালিয়ে যান",
    // | Step 2
    step2Title: "আপনার ইমেল লিখুন",
    ...
    postalCodeHint:
      "যদি জানেন, লিখুন — এটি যাচাই দ্রুত করে, তবে বাধ্যতামূলক নয়।",
    streetPlaceholder: "রাস্তা",
    houseNumberPlaceholder: "বাড়ি / ভবন নম্বর",
    apartmentPlaceholder: "অ্যাপার্টমেন্ট",
    statePlaceholder: "বিভাগ / অঞ্চল",
  ...
  id: {
    ...
    slideStep1Text: 'Klik "Dapatkan Bonus" dan selesaikan pendaftaran gratis.',
    slideStep2Title: "Aktifkan bonus",
    slideStep2Text:
      'Temukan bonus Anda di "Pusat Bonus" dan aktifkan untuk mulai bermain.',
    slideStep3Title: "Main",
    slideStep3Text: "Uang sekarang tersedia untuk bermain. Selamat menikmati!",
    footerText:
      "Semua konten di situs web ini disediakan hanya untuk tujuan pemasaran dan informasi. Konten ini tidak merupakan nasihat profesional, hukum, keuangan, medis, atau jenis nasihat lainnya. Kami tidak membuat pernyataan atau jaminan apa pun mengenai keakuratan, kelengkapan, atau kesesuaian informasi. Segala ketergantungan Anda pada konten ini sepenuhnya menjadi risiko Anda sendiri. Situs tidak bertanggung jawab atas kerugian atau kerusakan apa pun yang timbul akibat penggunaan situs web ini atau materinya.",
    // | FORM TRANSLATIONS
    backBtn: "Kembali",
    closeBtn: "Tutup",
    // | Step 1
    depToBalance: `<span>100 PUTARAN GRATIS</span>`,
    withoutDeposit: "Tanpa setoran",
    ...
    highRollerBonus: "Bonus High Roller",
    highRollerBonusText: "250% untuk Setoran Di Atas $500",
    withoutBonus: "Tanpa Bonus",
    withoutBonusText: "Anda tidak akan mendapatkan bonus apa pun",
    ...
    postalCodeHint:
      "Jika Anda mengetahuinya, masukkan — ini mempercepat verifikasi, tetapi tidak wajib.",
    streetPlaceholder: "Jalan",
    houseNumberPlaceholder: "Nomor rumah / gedung",
    apartmentPlaceholder: "Apartemen / unit",
    statePlaceholder: "Provinsi",
    zipCodePlaceholder: "Masukkan Kode Pos",
    createAccountBtn: "Buat Akun",
    // | Decline
    areYouSure: `Apakah Anda Yakin? <br /> Progres Anda Akan Hilang`,
    keepRegistering: "Lanjutkan Pendaftaran",
    returnToWebsite: "Kembali ke Situs",
    // | Названия полей, которые в части стран называются иначе
    apartmentUnitPlaceholder: "Unit",
    suburbPlaceholder: "Kawasan / Pinggiran kota",
    ...
    slideStep1Text: 'Napsauta "Hae bonus" ja suorita ilmainen rekisteröinti.',
    ...
    footerText:
      "Kaikki tämän verkkosivuston sisältö on tarkoitettu vain markkinointi- ja tiedotustarkoituksiin. Se ei ole ammatillista, oikeudellista, taloudellista, lääketieteellistä tai muuta neuvontaa. Emme anna minkäänlaisia vakuutuksia tai takuita tietojen oikeellisuudesta, täydellisyydestä tai soveltuvuudesta. Kaikki tämän sisällön varaan rakennettu luottamus on yksinomaan omalla vastuullasi. Sivusto ei ota mitään vastuuta tämän verkkosivuston tai sen materiaalien käytöstä aiheutuneista menetyksistä tai vahingoista.",
    // | FORM TRANSLATIONS
    backBtn: "Takaisin",
    closeBtn: "Sulje",
    // | Step 1
    ...
    returnToWebsite: "Palaa sivustolle",
    // | Названия полей, которые в части стран называются иначе
  ...
  dk: {
    ...
    slideStep3Text: "Pengene er nu tilgængelige til spil. Nyd det!",
    footerText:
      "Alt indhold på denne hjemmeside leveres udelukkende til markedsførings- og informationsformål. Det udgør ikke professionel, juridisk, finansiel, medicinsk eller nogen anden form for rådgivning. Vi giver ingen erklæringer eller garantier af nogen art vedrørende informationens nøjagtighed, fuldstændighed eller egnethed. Enhver tillid, du sætter til dette indhold, sker udelukkende på egen risiko. Siden påtager sig intet ansvar for tab eller skader, der opstår som følge af brugen af denne hjemmeside eller dens materialer.",
    // | FORM TRANSLATIONS
    backBtn: "Tilbage",
    closeBtn: "Luk",
    // | Step 1
    ...
    returnToWebsite: "Vend tilbage til hjemmesiden",
    // | Названия полей, которые в части стран называются иначе
  ...
  bg: {
    ...
    slideStep1Text:
      'Натиснете "Вземи бонус" и завършете безплатната регистрация.',
    slideStep2Title: "Активиране на бонус",
    slideStep2Text:
    ...
    footerText:
      "Цялото съдържание на този уебсайт е предоставено единствено с маркетингова и информационна цел. То не представлява професионален, правен, финансов, медицински или какъвто и да е друг вид съвет. Не правим никакви изявления или гаранции от какъвто и да е вид относно точността, пълнотата или пригодността на информацията. Всяко доверие, което имате към това съдържание, е изцяло на ваш собствен риск. Сайтът не поема никаква отговорност за загуби или щети, произтичащи от използването на този уебсайт или неговите материали.",
    // | FORM TRANSLATIONS
    backBtn: "Назад",
    closeBtn: "Затвори",
    // | Step 1
    ...
    welcomeBonusText: "за първия ви депозит",
    cryptoBonus: "Сатоши бонус",
    cryptoBonusText: "150% за крипто депозити",
    highRollerBonus: "Хай Ролър бонус",
    highRollerBonusText: "250% за депозити над $500",
    ...
    returnToWebsite: "Върни се на сайта",
    // | Названия полей, которые в части стран называются иначе
  ...
  nl: {
    ...
    slideStep2Text:
      'Vind je bonus in het "Bonuscentrum" en activeer het om te beginnen met spelen.',
    slideStep3Title: "Spelen",
    slideStep3Text: "Het geld is nu beschikbaar om te spelen. Veel plezier!",
    footerText:
      "Alle content op deze website wordt uitsluitend verstrekt voor marketing- en informatiedoeleinden. Het vormt geen professioneel, juridisch, financieel, medisch of enig ander soort advies. Wij geven geen verklaringen of garanties van welke aard dan ook met betrekking tot de juistheid, volledigheid of geschiktheid van de informatie. Elk vertrouwen dat u op deze content stelt, is volledig op eigen risico. De site aanvaardt geen verantwoordelijkheid of aansprakelijkheid voor enig verlies of schade als gevolg van het gebruik van deze website of haar materialen.",
    // | FORM TRANSLATIONS
    backBtn: "Terug",
    closeBtn: "Sluiten",
    // | Step 1
    ...
    withoutBonusText: "Je krijgt geen bonus",
  ...
  sw: {
    ...
    slideStep2Title: "Wezesha bonasi",
    slideStep2Text:
      'Pata bonasi yako katika "Kituo cha Bonasi" na uiwezeshe ili kuanza kucheza.',
    slideStep3Title: "Cheza",
    slideStep3Text: "Pesa sasa zinapatikana kwa kucheza. Furahia!",
    footerText:
      "Maudhui yote kwenye tovuti hii yanatolewa kwa madhumuni ya uuzaji na taarifa pekee. Hayajumuishi ushauri wa kitaaluma, kisheria, kifedha, kitabibu au aina nyingine yoyote ya ushauri. Hatutoi uwakilishi au dhamana ya aina yoyote kuhusu usahihi, ukamilifu au ufaafu wa taarifa. Kutegemea kwako maudhui haya ni kwa hatari yako mwenyewe kabisa. Tovuti haiwajibiki kwa hasara au uharibifu wowote unaotokana na matumizi ya tovuti hii au nyenzo zake.",
    // | FORM TRANSLATIONS
    backBtn: "Rudi",
    closeBtn: "Funga",
    // | Step 1
  ...
  am: {
    ...
    slideStep1Text: '"ቦነስ ያግኙ" የሚለውን ይጫኑና ነፃ ምዝገባውን ያጠናቅቁ።',
    slideStep2Title: "ቦነስ ያንቁ",
    slideStep2Text: 'ቦነስዎን በ"ቦነስ ማዕከል" ውስጥ ያግኙና መጫወት ለመጀመር ያንቁት።',
    slideStep3Title: "ይጫወቱ",
    slideStep3Text: "ገንዘቡ አሁን ለመጫወት ዝግጁ ነው። ይደሰቱ!",
    footerText:
      "በዚህ ድረ-ገጽ ላይ ያለው ሁሉም ይዘት ለግብይትና ለመረጃ ዓላማ ብቻ የቀረበ ነው። ሙያዊ፣ ሕጋዊ፣ ፋይናንሺያል፣ ሕክምና ወይም ሌላ ማንኛውም ዓይነት ምክር አይደለም። ስለ መረጃው ትክክለኛነት፣ ሙሉነት ወይም ተስማሚነት ምንም ዓይነት ማረጋገጫ ወይም ዋስትና አንሰጥም። በዚህ ይዘት ላይ የሚያደርጉት ማንኛውም መተማመን ሙሉ በሙሉ በራስዎ ኃላፊነት ነው። ይህን ድረ-ገጽ ወይም ቁሳቁሶቹን በመጠቀም ለሚደርስ ማንኛውም ኪሳራ ወይም ጉዳት ድረ-ገጹ ምንም ኃላፊነት አይወስድም።",
    // | FORM TRANSLATIONS
    backBtn: "ተመለስ",
    closeBtn: "ዝጋ",
    // | Step 1
    ...
    cryptoBonus: "ሳቶሺ ቦነስ",
    cryptoBonusText: "በክሪፕቶ ተቀማጭ ላይ 150%",
    highRollerBonus: "ሃይ ሮለር ቦነስ",
    highRollerBonusText: "ከ$500 በላይ ተቀማጭ ላይ 250%",
    withoutBonus: "ያለ ቦነስ",
    withoutBonusText: "ምንም ቦነስ አያገኙም",
    iHavePromoCode: "የማስተዋወቂያ ኮድ አለኝ",
    promoCodePlaceHolder: "የማስተዋወቂያ ኮድ",
  ...
  lm: {
    ...
    slideStep1Text: 'Nyiga "Funa Bonasi" omale okwewandiisa okw\'obwereere.',
    slideStep2Title: "Kozesa bonasi",
    slideStep2Text:
      'Funa bonasi yo mu "Bonus Center" ogikozese okutandika okuzannya.',
    slideStep3Title: "Zannya",
    slideStep3Text: "Ssente kati zisangibwa okuzannya. Sanyuka!",
    footerText:
      "Ebintu byonna ebiri ku mukutu guno biweebwa ku nsonga z'okutunda n'okuwa amawulire kwokka. Tebikola ng'amagezi ag'ekikugu, ag'amateeka, ag'ensimbi, ag'eddagala, oba ag'engeri endala yonna. Tetuwa kakalu konna ku butuufu, obujjuvu, oba okusaanira kw'amawulire. Okwesiga kwonna kw'oteeka ku bintu bino kuli ku bulabe bwo wekka. Omukutu teguvunaanyizibwa ku kufiirwa oba okwonooneka kwonna okuva mu kukozesa omukutu guno oba ebintu byagwo.",
    // | FORM TRANSLATIONS
    backBtn: "Ddayo",
    closeBtn: "Ggalawo",
    // | Step 1
    depToBalance: `<span>SPINS 100 EZ'OBWEREERE</span>`,
    withoutDeposit: "Awatali kuteeka ssente",
    step1Title: "Londa Bonasi Yo",
    welcomeBonus: "Bonasi y'Okwaniriza",
    welcomeBonusText: "ku deposit yo ey'olubereberye",
    cryptoBonus: "Bonasi ya Satoshi",
    cryptoBonusText: "150% ku Deposit za Crypto",
    highRollerBonus: "Bonasi ya High Roller",
    highRollerBonusText: "250% ku Deposit ezisukka $500",
    withoutBonus: "Awatali Bonasi",
    withoutBonusText: "Tojja kufuna bonasi yonna",
    iHavePromoCode: "Nnina Promo-Code",
    promoCodePlaceHolder: "Promo Code",
    ...
    age18Alert: "Emyaka gisaana okuba 18+",
    invalidDate: "Olunaku olutali lutuufu",
    male: "Musajja",
    female: "Mukazi",
    finalStepBtn: "Omutendera ogw'Enkomerero",
    // | Step 4
    ...
    createAccountBtn: "Kola Akawunti",
    // | Decline
    areYouSure: `Oli Mukakafu? <br /> Enkulaakulana Yo Ejja Kubula`,
  ...
  rw: {
    ...
    slideStep1Text: 'Kanda "Fata Bonus" maze urangize kwiyandikisha ku buntu.',
    slideStep2Title: "Koresha bonus",
    slideStep2Text:
      'Shaka bonus yawe muri "Ikigo cya Bonus" maze uyikoreshe kugira ngo utangire gukina.',
    slideStep3Title: "Kina",
    slideStep3Text: "Amafaranga ubu araboneka kugira ngo ukine. Wishimire!",
    footerText:
      "Ibikubiye byose kuri uru rubuga bitangwa gusa ku mpamvu zo kwamamaza no gutanga amakuru. Ntibigize inama y'umwuga, iy'amategeko, iy'imari, iy'ubuvuzi cyangwa indi nama iyo ari yo yose. Ntidutanga icyemezo cyangwa ingwate iyo ari yo yose ku kuri, ku kuzura cyangwa ku kuba bikwiriye kw'amakuru. Icyizere icyo ari cyo cyose ushyira muri ibi bikubiyemo kiri ku byago byawe bwite. Urubuga ntirwishingira igihombo cyangwa ikindi kibazo cyose giterwa no gukoresha uru rubuga cyangwa ibikoresho byarwo.",
    // | FORM TRANSLATIONS
    backBtn: "Subira inyuma",
    closeBtn: "Funga",
    // | Step 1
    depToBalance: `<span>KUZENGURUKA 100 KU BUNTU</span>`,
    withoutDeposit: "Nta depo",
    step1Title: "Hitamo Bonus Yawe",
    welcomeBonus: "Bonus yo Kwakira",
    welcomeBonusText: "kuri depo yawe ya mbere",
    cryptoBonus: "Bonus ya Satoshi",
    cryptoBonusText: "150% kuri Depo za Crypto",
    highRollerBonus: "Bonus ya High Roller",
    highRollerBonusText: "250% kuri Depo zirenga $500",
    ...
    // | Decline
    areYouSure: `Urabyizeye? <br /> Aho Wari Ugeze Hazatakara`,
  ...
  ar: {
    ...
    slideStep2Text: 'ابحث عن مكافأتك في "مركز المكافآت" وفعّلها لبدء اللعب.',
    slideStep3Title: "العب",
    slideStep3Text: "أصبحت الأموال متاحة الآن للعب. استمتع!",
    footerText:
      "جميع المحتويات الموجودة على هذا الموقع مقدمة لأغراض التسويق والمعلومات فقط. وهي لا تشكل نصيحة مهنية أو قانونية أو مالية أو طبية أو أي نوع آخر من النصائح. نحن لا نقدم أي إقرارات أو ضمانات من أي نوع بشأن دقة المعلومات أو اكتمالها أو ملاءمتها. أي اعتماد منك على هذا المحتوى يكون على مسؤوليتك الخاصة بالكامل. لا يتحمل الموقع أي مسؤولية أو التزام عن أي خسارة أو ضرر ينتج عن استخدام هذا الموقع أو مواده.",
    // | FORM TRANSLATIONS
    backBtn: "رجوع",
    closeBtn: "إغلاق",
    // | Step 1
  ...
  mt: {
    ...
    footerText:
      "Il-kontenut kollu fuq dan is-sit huwa pprovdut għal skopijiet ta' marketing u informazzjoni biss. Ma jikkostitwixxix parir professjonali, legali, finanzjarju, mediku jew ta' xi tip ieħor. Ma nagħmlu l-ebda rappreżentazzjoni jew garanzija ta' ebda tip dwar l-eżattezza, il-kompletezza jew l-adegwatezza tal-informazzjoni. Kwalunkwe dipendenza li tqiegħed fuq dan il-kontenut hija strettament għar-riskju tiegħek stess. Is-sit ma jassumi l-ebda responsabbiltà għal kwalunkwe telf jew ħsara li tirriżulta mill-użu ta' dan is-sit jew tal-materjali tiegħu.",
    // | FORM TRANSLATIONS
    backBtn: "Lura",
    closeBtn: "Agħlaq",
    // | Step 1
    depToBalance: `<span>100 SPIN B'XEJN</span>`,
    ...
    cryptoBonus: "Bonus Satoshi",
    cryptoBonusText: "150% fuq Depożiti tal-Crypto",
    highRollerBonus: "Bonus High Roller",
  ...
  lb: {
    ...
    slideStep1Text:
      'Klick op "Bonus kréien" a maach déi gratis Umeldung fäerdeg.',
    slideStep2Title: "Bonus aktivéieren",
    slideStep2Text:
      'Fann däre Bonus am "Bonus Center" an aktivéier en fir unzefänken ze spillen.',
    slideStep3Title: "Spillen",
    slideStep3Text: "D'Suen sinn elo verfügbar fir ze spillen. Vill Spaass!",
    footerText:
      "Den ganzen Inhalt op dëser Websäit gëtt nëmme fir Marketing- an Informatiounszwecker zur Verfügung gestallt. Et stellt keng professionell, juristesch, finanziell, medizinesch oder aner Aart vu Berodung duer. Mir maachen keng Versécherungen oder Garantien iwwer d'Genauegkeet, d'Vollständegkeet oder d'Eegnung vun den Informatiounen. All Vertrauen dat Dir an dësen Inhalt setzt ass strikt op Äert eegent Risiko. D'Säit iwwerhëlt keng Verantwortung fir all Verloscht oder Schued deen duerch d'Notzung vun dëser Websäit oder hire Materialien entsteet.",
    // | FORM TRANSLATIONS
    backBtn: "Zréck",
    closeBtn: "Zoumaachen",
    // | Step 1
    depToBalance: `<span>100 GRATIS SPINS</span>`,
    withoutDeposit: "Ouni Depot",
    step1Title: "Wiel däre Bonus",
    welcomeBonus: "Wëllkommsbonus",
    welcomeBonusText: "op dengem éischten Depot",
    cryptoBonus: "Satoshi Bonus",
    cryptoBonusText: "150% op Krypto-Depoten",
    highRollerBonus: "High Roller Bonus",
    highRollerBonusText: "250% op Depoten iwwer $500",
    ...
    birthdayPlaceholder: "Gebuertsdatum wielen",
    age18Alert: "Alter muss 18+ sinn",
    invalidDate: "Ongëlteg Datum",
    male: "Mann",
    female: "Fra",
    finalStepBtn: "Lescht Etapp",
    // | Step 4
    step4Title: "Währung wielen",
    countryPlaceholder: "Land wielen",
    ...
    // | Decline
    areYouSure: `Bass du sécher? <br /> Däre Fortschrëtt geet verluer`,
  ...
  ga: {
    ...
    slideStep3Text:
      "Tá an t-airgead ar fáil anois le haghaidh imeartha. Bain sult as!",
    footerText:
      "Soláthraítear gach ábhar ar an suíomh gréasáin seo chun críocha margaíochta agus faisnéise amháin. Ní comhairle ghairmiúil, dhlíthiúil, airgeadais, leighis ná aon chineál comhairle eile í. Ní dhéanaimid aon uiríoll ná baránta de chineál ar bith maidir le cruinneas, iomláine nó oiriúnacht na faisnéise. Tá aon mhuinín a chuireann tú san ábhar seo go hiomlán ar do phriacal féin. Ní ghlacann an suíomh aon fhreagracht as aon chaillteanas nó damáiste a tharlaíonn mar thoradh ar úsáid an tsuímh seo nó a ábhair.",
    // | FORM TRANSLATIONS
    backBtn: "Ar ais",
    closeBtn: "Dún",
    // | Step 1
    depToBalance: `<span>100 CASADH SAOR IN AISCE</span>`,
    ...
    emailPlaceholder: "Cuir isteach R-phost",
    ...
    age18Alert: "Caithfidh an aois a bheith 18+",
    ...
    phoneNumberPlaceholder: "Uimhir Ghutháin",
  ...
  ha: {
    ...
    slideStep1Text: 'Danna "Samu Bonus" sannan ka kammala rajistar kyauta.',
    slideStep2Title: "Kunna bonus",
    slideStep2Text:
      'Nemo bonus ɗinka a "Cibiyar Bonus" sannan ka kunna shi don fara wasa.',
    slideStep3Title: "Yi wasa",
    slideStep3Text: "Kuɗin yanzu suna samuwa don wasa. Ji daɗi!",
    footerText:
      "Dukkan abubuwan da ke wannan gidan yanar gizo ana bayar da su ne don dalilai na talla da bayanai kawai. Ba shawara ce ta ƙwararru, ta shari'a, ta kuɗi, ta likita ko wani nau'i ba. Ba mu yin wani tabbaci ko garanti na kowane iri game da daidaito, cikar bayani ko dacewar bayanan. Duk wani dogaro da ka yi kan wannan abun ciki yana kan haɗarinka kai kaɗai. Gidan yanar gizon ba ya ɗaukar wani alhaki kan duk wani asara ko lahani da ya samu sakamakon amfani da wannan gidan yanar gizo ko kayanta.",
    // | FORM TRANSLATIONS
    backBtn: "Koma baya",
    closeBtn: "Rufe",
    // | Step 1
    depToBalance: `<span>JUYA 100 KYAUTA</span>`,
    withoutDeposit: "Ba tare da ajiya ba",
    step1Title: "Zaɓi Bonus ɗinka",
    welcomeBonus: "Bonus na Maraba",
    welcomeBonusText: "akan ajiyarka ta farko",
    cryptoBonus: "Bonus na Satoshi",
    cryptoBonusText: "150% akan Ajiyar Crypto",
    highRollerBonus: "Bonus na High Roller",
    highRollerBonusText: "250% akan Ajiya sama da $500",
  ...
  yo: {
    ...
    slideStep2Title: "Mu ẹ̀bùn ṣiṣẹ́",
    slideStep2Text:
      'Wá ẹ̀bùn rẹ nínú "Ilé-iṣẹ́ Ẹ̀bùn" kí o sì mu un ṣiṣẹ́ láti bẹ̀rẹ̀ eré.',
    slideStep3Title: "Ṣeré",
    slideStep3Text: "Owó náà ti wà báyìí fún eré. Gbádùn!",
    footerText:
      "Gbogbo àkóónú lórí ojú-òpó yìí ni a pèsè fún ìpolówó àti ìròyìn nìkan. Kì í ṣe ìmọ̀ràn akọ́ṣẹ́mọṣẹ́, t'òfin, ti ìnáwó, ti ìṣègùn tàbí irú ìmọ̀ràn mìíràn. A kì í ṣe àfihàn tàbí ìdánilójú irú kankan nípa ìdọ́gba, ìpé tàbí ìbámu àlàyé náà. Ìgbẹ́kẹ̀lé èyíkéyìí tí o bá fi sára àkóónú yìí wà lórí ewu ara rẹ pátápátá. Ojú-òpó náà kì í gba ojúṣe kankan fún àdánù tàbí ìbàjẹ́ èyíkéyìí tí ó bá wáyé nítorí lílo ojú-òpó yìí tàbí àwọn ohun èlò rẹ̀.",
    // | FORM TRANSLATIONS
    backBtn: "Padà",
    closeBtn: "Tì",
    // | Step 1
    depToBalance: `<span>ÀYÍKÁ Ọ̀FẸ́ 100</span>`,
    withoutDeposit: "Láìsí ìdọ̀wó",
    step1Title: "Yan Ẹ̀bùn Rẹ",
    welcomeBonus: "Ẹ̀bùn Ìkíni",
    welcomeBonusText: "lórí ìdọ̀wó àkọ́kọ́ rẹ",
    cryptoBonus: "Ẹ̀bùn Satoshi",
    cryptoBonusText: "150% lórí Ìdọ̀wó Crypto",
    highRollerBonus: "Ẹ̀bùn High Roller",
    highRollerBonusText: "250% lórí Ìdọ̀wó tó ju $500 lọ",
    ...
    // | Step 2
    step2Title: "Tẹ Ímeèlì Rẹ Sí",
    emailPlaceholder: "Tẹ Ímeèlì",
    passwordPlaceholder: "Tẹ Ọ̀rọ̀ Ìpamọ́",
    // | Step 3
    ...
    zipCodePlaceholder: "Tẹ Koodu ZIP",
    createAccountBtn: "Ṣẹ̀dá Àkáǹtì",
    // | Decline
    areYouSure: `Ṣé o dá ọ lójú? <br /> Ìlọsíwájú Rẹ Yóò Sọnù`,
  ...
  ig: {
    ...
    slideStep1Text: 'Pịa "Nweta Ọnyinye" wee mechaa ndebanye aha efu.',
    slideStep2Title: "Kwado ọnyinye",
    slideStep2Text:
      'Chọta ọnyinye gị na "Ebe Ọnyinye" wee kwado ya iji malite igwu egwu.',
    slideStep3Title: "Gwuo egwu",
    slideStep3Text: "Ego ahụ dị ugbu a maka igwu egwu. Nwee obi ụtọ!",
    footerText:
      "A na-enye ọdịnaya niile dị na webụsaịtị a naanị maka ebumnuche ahịa na ozi. Ọ bụghị ndụmọdụ ọkachamara, nke iwu, nke ego, nke ahụike ma ọ bụ ụdị ndụmọdụ ọzọ ọ bụla. Anyị adịghị eme nkwupụta ma ọ bụ akwụkwọ nkwa ọ bụla gbasara izi ezi, izu oke ma ọ bụ ịdaba nke ozi ahụ. Ntụkwasị obi ọ bụla ị na-etinye n'ọdịnaya a dị naanị n'ihe ize ndụ nke gị. Saịtị anaghị ewere ọrụ ọ bụla maka mfu ma ọ bụ mmebi ọ bụla nke sitere n'iji webụsaịtị a ma ọ bụ ihe ndị dị na ya.",
    // | FORM TRANSLATIONS
    backBtn: "Laghachi azụ",
    closeBtn: "Mechie",
    // | Step 1
    depToBalance: `<span>NTỤGHARỊ EFU 100</span>`,
    withoutDeposit: "Na-enweghị ntinye ego",
    step1Title: "Họrọ Ọnyinye Gị",
    welcomeBonus: "Ọnyinye Nnabata",
    welcomeBonusText: "na ntinye ego mbụ gị",
    cryptoBonus: "Ọnyinye Satoshi",
    cryptoBonusText: "150% na Ntinye Crypto",
    highRollerBonus: "Ọnyinye High Roller",
    highRollerBonusText: "250% na Ntinye Karịrị $500",
    withoutBonus: "Na-enweghị Ọnyinye",
    withoutBonusText: "Ị gaghị enweta ọnyinye ọ bụla",
    ...
    passwordPlaceholder: "Tinye Okwuntụaka",
    // | Step 3
    step3Title: "Gịnị bụ aha gị?",
    namePlaceholder: "Aha",
    lastNamePlaceholder: "Aha Nna",
    ...
    // | Decline
    areYouSure: `Ị ji n'aka? <br /> Ọganihu Gị Ga-efunahụ`,
  ...
  tw: {
    ...
    slideStep1Text: 'Klike "Gye Akyɛde" na wie nkyerɛwdin a ɛyɛ kwa no.',
    slideStep2Title: "Sɔ akyɛde no ano",
    slideStep2Text:
      'Hwehwɛ wo akyɛde wɔ "Akyɛde Beae" no na sɔ ano na fi ase di agorɔ.',
    slideStep3Title: "Di agorɔ",
    slideStep3Text: "Sika no wɔ hɔ seesei ma agodie. Nya anigye!",
    footerText:
      "Nsɛm a ɛwɔ saa wɛbsaet yi so nyinaa wɔde ma wɔ dwadie ne nsɛm ho nko ara. Ɛnyɛ adwumayɛfo, mmara, sika, ayaresa anaa ɔkwan foforɔ biara so afotuo. Yɛnyɛ nkyerɛkyerɛmu anaa bɔhyɛ biara fa nsɛm no mu nokware, ne mma anaa sɛ ɛfata ho. Ahotoso biara a wode hyɛ saa nsɛm yi mu no wɔ wo ankasa asiane ase koraa. Saet no nnfa asɛyɛde biara a ɛfa adehwere anaa ɔsɛe biara a ɛba esiane saa wɛbsaet yi anaa emu nneɛma a wode di dwuma nti.",
    // | FORM TRANSLATIONS
    backBtn: "San kɔ",
    closeBtn: "To mu",
    // | Step 1
    depToBalance: `<span>SPINS 100 A ƐYƐ KWA</span>`,
    withoutDeposit: "Deposit nni hɔ",
    step1Title: "Paw Wo Akyɛde",
    welcomeBonus: "Akwaaba Akyɛde",
    welcomeBonusText: "wɔ wo deposit a edi kan no so",
    cryptoBonus: "Satoshi Akyɛde",
    cryptoBonusText: "150% wɔ Crypto Deposit so",
    highRollerBonus: "High Roller Akyɛde",
    highRollerBonusText: "250% wɔ Deposit a ɛboro $500 so",
    withoutBonus: "Akyɛde nni hɔ",
    withoutBonusText: "Worennya akyɛde biara",
    iHavePromoCode: "Mewɔ Promo-Code",
    promoCodePlaceHolder: "Promo Code",
    promoCodeApplyBtn: "Fa di dwuma",
    continueBtn: "Toa so",
    // | Step 2
    step2Title: "Kyerɛw Wo Email",
    emailPlaceholder: "Kyerɛw E-mail",
    passwordPlaceholder: "Kyerɛw Password",
    // | Step 3
    step3Title: "Wo din de sɛn?",
    namePlaceholder: "Din",
    lastNamePlaceholder: "Abusua Din",
    birthdayPlaceholder: "Paw Awoda",
    age18Alert: "Mfeɛ ɛsɛ sɛ ɛyɛ 18+",
    ...
    addressPlaceholder: "Kyerɛw Address",
    cityPlaceholder: "Kyerɛw Kurow",
    postalCodeHint:
    ...
    zipCodePlaceholder: "Kyerɛw ZIP Code",
    createAccountBtn: "Bɔ Akawnt",
    // | Decline
    areYouSure: `So wo gyidie wɔ mu? <br /> Wo Nkɔso Bɛyera`,
    keepRegistering: "Toa Nkyerɛwdin so",
