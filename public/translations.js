export const translations = {
  ...
  pl: {
    ...
    heroTitle: `ODBIERZ SWÓJ BONUS <br/> <span><i class="actual-spin-amount">100</i> darmowych spinów</span> <br/> w <span>book of dead</span>`,
  ...
  az: {
    ...
    statePlaceholder: "Region / Rayon",
    streetPlaceholder: "Küçə",
    houseNumberPlaceholder: "Ev / Bina nömrəsi",
    apartmentPlaceholder: "Mənzil",
    postalCodeHint:
      "Bilirsinizsə, daxil edin — bu, yoxlamanı sürətləndirir, lakin məcburi deyil.",
    ...
    // | Названия полей, которые в части стран называются иначе
    apartmentUnitPlaceholder: "Mənzil",
  ...
  kz: {
    ...
    statePlaceholder: "Облыс / Аймақ",
    streetPlaceholder: "Көше",
    houseNumberPlaceholder: "Үй / ғимарат нөмірі",
    apartmentPlaceholder: "Пәтер",
    postalCodeHint:
      "Білсеңіз, енгізіңіз — бұл тексеруді жылдамдатады, бірақ міндетті емес.",
    ...
    // | Названия полей, которые в части стран называются иначе
    apartmentUnitPlaceholder: "Пәтер",
