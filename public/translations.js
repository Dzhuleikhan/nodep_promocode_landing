export const translations = {
  ...
  zh: {
    ...
    footerText:
      "Goldbet.io 由 Goldkey Technologies Limitada 拥有并运营。注册号：3-102-892568，注册地址：哥斯达黎加蓬塔雷纳斯省哈科61101，Pastor Diaz大道。联系我们：hello@goldbet.io。Goldbet.io 由科摩罗联盟昂儒昂自治岛政府授权并监管，许可证编号：ALSI-012401005-F11。Goldbet.io 已通过所有监管合规要求，并被合法授权开展所有机会类游戏和投注业务。请记住，赌博可能会上瘾。请理性娱乐。Goldbet.io 仅接受年满18周岁的客户，具体取决于您所在司法管辖区。Goldkey Technologies Limitada（注册号 3-102-892568）依据哥斯达黎加法律成立并运营，是 Goldkey Technologies Limitada 的支付运营方，作为其支付代理。GOLD SYNG INC.TECH LTD 在塞浦路斯共和国依法注册成立，公司注册号 HE456057。",
    // | FORM TRANSLATIONS
    backBtn: "返回",
    closeBtn: "关闭",
    // | Step 1
  ...
  ga: {
    ...
    footerText:
      "Is le Goldkey Technologies Limitada Goldbet.io agus tá sé á oibriú aige. Uimhir chláraithe: 3-102-892568, seoladh cláraithe: Puntarenas - Pastor Diaz ave. Puntarenas Province, Jaco, 61101, Costa Rica. Déan teagmháil linn hello@goldbet.io. Tá Goldbet.io ceadúnaithe agus rialaithe ag Rialtas Oileán Uathrialach Anjouan, Aontas na gComoros agus oibríonn sé faoi Cheadúnas Uimh. ALSI-012401005-F11. Tá Goldbet.io tar éis gach ceanglas rialála a chomhlíonadh agus tá sé údaraithe go dleathach oibríochtaí cearrbhachais agus gealltóireachta a dhéanamh. Cuimhnigh gur féidir le cearrbhachas a bheith andúileach. Imir go freagrach. Ní ghlacann Goldbet.io ach le custaiméirí 18 mbliana d’aois nó níos sine de réir do dhlínse. Tá Goldkey Technologies Limitada, uimhir chláraithe 3-102-892568, eagraithe agus á oibriú faoi dhlí Costa Rica, ag feidhmiú mar ghníomhaire íocaíochta thar ceann Goldkey Technologies Limitada. Tá GOLD SYNG INC.TECH LTD corpraithe go dleathach i bPoblacht na Cipire, faoi uimhir HE456057.",
    // | FORM TRANSLATIONS
    backBtn: "Ar ais",
    closeBtn: "Dún",
    // | Step 1
  ...
  lb: {
    ...
    footerText:
      "Goldbet.io gëtt besëtzt a bedriwwen vun Goldkey Technologies Limitada. Registréierungsnummer: 3-102-892568, registréiert Adress: Puntarenas - Pastor Diaz ave. Puntarenas Province, Jaco, 61101, Costa Rica. Kontakt: hello@goldbet.io. Goldbet.io ass lizenzéiert a reguléiert vun der Regierung vun der Autonomer Insel Anjouan, Unioun vun de Komoren, a funktionéiert ënner Lizenz Nr. ALSI-012401005-F11. Goldbet.io huet all reglementaresch Ufuerderunge erfëllt an ass legal autoriséiert fir Glécksspiller- a Wettenoperatiounen ze bedreiwen. Denkt drun datt Glécksspiller süchteg kënne sinn. Spillt verantwortlech. Goldbet.io akzeptéiert nëmme Clienten déi 18 Joer oder méi al sinn no Ärer Juridictioun. Goldkey Technologies Limitada, Registréierungsnummer 3-102-892568, organiséiert a bedriwwen ënner de Gesetzer vu Costa Rica, handelt als Bezuelungsagent am Numm vu Goldkey Technologies Limitada. GOLD SYNG INC.TECH LTD ass gesetzlech an der Republik Zypern gegrënnt, ënner Firmenregistréierungsnummer HE456057.",
    // | FORM TRANSLATIONS
    backBtn: "Zréck",
    closeBtn: "Zoumaachen",
    // | Step 1
  ...
  mt: {
    ...
    footerText:
      "Goldbet.io huwa proprjetà u mħaddem minn Goldkey Technologies Limitada. Numru ta’ reġistrazzjoni: 3-102-892568, indirizz irreġistrat: Puntarenas - Pastor Diaz ave. Puntarenas Province, Jaco, 61101, Costa Rica. Ikkuntattjana hello@goldbet.io. Goldbet.io huwa liċenzjat u rregolat mill-Gvern tal-Gżira Awtonoma ta’ Anjouan, Unjoni tal-Komoros u jopera taħt Liċenzja Nru ALSI-012401005-F11. Goldbet.io għadda mill-konformità regolatorja kollha u huwa legalment awtorizzat biex iwettaq operazzjonijiet ta’ logħob u mħatri. Ftakar li l-logħob tal-azzard jista’ jkun vizzju. Ilgħab b’mod responsabbli. Goldbet.io jaċċetta biss klijenti ta’ 18-il sena jew aktar skont il-ġurisdizzjoni tiegħek. Goldkey Technologies Limitada, numru ta’ reġistrazzjoni 3-102-892568, kumpanija organizzata u mħaddma taħt il-liġi ta’ Costa Rica, taġixxi bħala aġent tal-ħlas f’isem Goldkey Technologies Limitada. GOLD SYNG INC.TECH LTD inkorporata fir-Repubblika ta’ Ċipru, taħt numru HE456057.",
    // | FORM TRANSLATIONS
    backBtn: "Lura",
    closeBtn: "Agħlaq",
    // | Step 1
