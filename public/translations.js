export const translations = {
  ...
  nl: {
    ...
    footerText:
      "Goldbet.io is eigendom van en wordt beheerd door Goldkey Technologies Limitada. Registratienummer: 3-102-892568, geregistreerd adres: Puntarenas - Pastor Diaz ave. Puntarenas Province, Jaco, 61101, Costa Rica. Neem contact met ons op via hello@goldbet.io. Goldbet.io is gelicentieerd en gereguleerd door de regering van het Autonome Eiland Anjouan, Unie van de Comoren en opereert onder licentienummer ALSI-012401005-F11. Goldbet.io heeft alle wettelijke nalevingscontroles doorstaan en is wettelijk bevoegd om gokactiviteiten uit te voeren voor alle kansspelen en weddenschappen. Onthoud dat gokken verslavend kan zijn. Speel verantwoord. Goldbet.io accepteert alleen klanten van 18 jaar en ouder in overeenstemming met jouw rechtsgebied. Goldkey Technologies Limitada, registratienummer 3-102-892568, een bedrijf opgericht en opererend volgens de wetgeving van Costa Rica, is de betalingsoperator van Goldkey Technologies Limitada en treedt op als betaalagent namens Goldkey Technologies Limitada. GOLD SYNG INC.TECH LTD is naar behoren opgericht en georganiseerd in de Republiek Cyprus, onder bedrijfsregistratienummer HE456057 ",
    // | FORM TRANSLATIONS
    backBtn: "Terug",
    closeBtn: "Sluiten",
    // | Step 1
  ...
  ar: {
    ...
    footerText:
      "Goldbet.io مملوكة وتدار من قبل Goldkey Technologies Limitada. رقم التسجيل: 3-102-892568، العنوان المسجل: بونتاريناس - شارع باستور دياز. مقاطعة بونتاريناس، جاكو، 61101، كوستاريكا. تواصل معنا عبر hello@goldbet.io. Goldbet.io مرخصة ومنظمة من قبل حكومة جزيرة أنجوان المستقلة، اتحاد جزر القمر وتعمل بموجب الترخيص رقم ALSI-012401005-F11. اجتازت Goldbet.io جميع متطلبات الامتثال التنظيمي وهي مخولة قانونيًا لإجراء عمليات الألعاب لجميع ألعاب الحظ والمراهنات. تذكر أن المقامرة قد تكون مسببة للإدمان. العب بمسؤولية. Goldbet.io تقبل فقط العملاء الذين تبلغ أعمارهم 18 عامًا أو أكثر وفقًا لاختصاصك القضائي. Goldkey Technologies Limitada، رقم التسجيل 3-102-892568، شركة منظمة وتعمل وفقًا لقوانين كوستاريكا، هي مشغل الدفع لشركة Goldkey Technologies Limitada، وتعمل كوكيل دفع نيابة عن Goldkey Technologies Limitada. شركة GOLD SYNG INC.TECH LTD مسجلة ومنظمة حسب الأصول في جمهورية قبرص، تحت رقم تسجيل الشركة HE456057 ",
    // | FORM TRANSLATIONS
    backBtn: "رجوع",
    closeBtn: "إغلاق",
    // | Step 1
  ...
  zh: {
    ...
    footerText:
      "Goldbet.io 由 Goldkey Technologies Limitada 拥有并运营。注册号：3-102-892568，注册地址：Puntarenas - Pastor Diaz ave. Puntarenas Province, Jaco, 61101, Costa Rica。联系我们：hello@goldbet.io。Goldbet.io 由科摩罗联盟安儒昂自治岛政府许可和监管，并在许可证号 ALSI-012401005-F11 下运营。Goldbet.io 已通过所有监管合规要求，并被合法授权开展所有机会类游戏和投注业务。请记住，赌博可能会令人上瘾。请理性游戏。根据您所在司法辖区的规定，Goldbet.io 仅接受年满 18 岁或以上的客户。Goldkey Technologies Limitada（注册号 3-102-892568）是一家根据哥斯达黎加法律成立并运营的公司，是 Goldkey Technologies Limitada 的支付运营商，作为支付代理代表 Goldkey Technologies Limitada 行事。GOLD SYNG INC.TECH LTD 已在塞浦路斯共和国正式注册成立，公司注册号为 HE456057 ",
    // | FORM TRANSLATIONS
    backBtn: "返回",
    closeBtn: "关闭",
    // | Step 1
  ...
  sw: {
    ...
    footerText:
      "Goldbet.io inamilikiwa na kuendeshwa na Goldkey Technologies Limitada. Nambari ya usajili: 3-102-892568, anwani iliyosajiliwa: Puntarenas - Pastor Diaz ave. Mkoa wa Puntarenas, Jaco, 61101, Costa Rica. Wasiliana nasi kupitia hello@goldbet.io. Goldbet.io imepewa leseni na kusimamiwa na Serikali ya Kisiwa Huru cha Anjouan, Muungano wa Komoro na inafanya kazi chini ya Leseni Na. ALSI-012401005-F11. Goldbet.io imepitisha mahitaji yote ya kufuata kanuni na imeidhinishwa kisheria kuendesha shughuli za michezo ya kubahatisha kwa michezo yote ya bahati na ubashiri. Kumbuka kuwa kamari inaweza kusababisha uraibu. Cheza kwa uwajibikaji. Goldbet.io inakubali tu wateja wenye umri wa miaka 18 au zaidi kulingana na mamlaka yako. Goldkey Technologies Limitada, nambari ya usajili 3-102-892568, kampuni iliyoanzishwa na kuendeshwa chini ya sheria za Costa Rica, ndiye mwendeshaji wa malipo wa Goldkey Technologies Limitada, akifanya kazi kama wakala wa malipo kwa niaba ya Goldkey Technologies Limitada. GOLD SYNG INC.TECH LTD imeanzishwa na kusajiliwa ipasavyo katika Jamhuri ya Kupro, chini ya Nambari ya Usajili wa Kampuni HE456057 ",
    // | FORM TRANSLATIONS
    backBtn: "Rudi",
    closeBtn: "Funga",
    // | Step 1
  ...
  rw: {
    ...
    footerText:
      "Goldbet.io ifitwe kandi ikoreshwa na Goldkey Technologies Limitada. Nimero y’iyandikwa: 3-102-892568, aderesi yanditswe: Puntarenas - Pastor Diaz ave. Intara ya Puntarenas, Jaco, 61101, Costa Rica. Twandikire kuri hello@goldbet.io. Goldbet.io ifite uruhushya kandi igenzurwa na Leta y’Ikirwa cyigenga cya Anjouan, Ubumwe bwa Comoros kandi ikora hakurikijwe Uruhushya No. ALSI-012401005-F11. Goldbet.io yujuje ibisabwa byose by’amategeko kandi yemerewe gukora ibikorwa by’imikino y’amahirwe n’ikorwa ry’inyungu. Wibuke ko gukina amahirwe bishobora guteza ubusinzi bwo kubikora. Kina witonze. Goldbet.io yemera gusa abakiriya bafite imyaka 18 cyangwa irenga hakurikijwe aho ubarizwa. Goldkey Technologies Limitada, nimero y’iyandikwa 3-102-892568, isosiyete yashinzwe kandi ikora hakurikijwe amategeko ya Costa Rica, ni yo mucungamutungo w’ubwishyu wa Goldkey Technologies Limitada, ikora nk’umukozi wishyura mu izina rya Goldkey Technologies Limitada. GOLD SYNG INC.TECH LTD yashinzwe kandi yanditswe neza muri Repubulika ya Cyprus, ifite nimero y’iyandikwa ry’isosiyete HE456057 ",
    // | FORM TRANSLATIONS
  ...
  ga: {
    ...
    footerText:
      "Is le Goldkey Technologies Limitada agus á oibriú ag Goldkey Technologies Limitada é Goldbet.io. Uimhir chlárúcháin: 3-102-892568, seoladh cláraithe: Puntarenas - Pastor Diaz ave. Cúige Puntarenas, Jaco, 61101, Costa Rica. Déan teagmháil linn ag hello@goldbet.io. Tá Goldbet.io ceadúnaithe agus rialáilte ag Rialtas Oileán Uathrialach Anjouan, Aontas na gComoros agus oibríonn sé faoi Cheadúnas Uimh. ALSI-012401005-F11. Tá Goldbet.io tar éis gach riachtanas comhlíonta rialála a chomhlíonadh agus tá sé údaraithe go dleathach oibríochtaí cearrbhachais a dhéanamh do gach cluiche seans agus gealltóireachta. Cuimhnigh go bhféadfadh cearrbhachas a bheith andúileach. Imir go freagrach. Ní ghlacann Goldbet.io ach le custaiméirí atá 18 mbliana d’aois nó níos sine de réir do dhlínse. Goldkey Technologies Limitada, uimhir chlárúcháin 3-102-892568, cuideachta a bunaíodh agus a oibríonn faoi dhlíthe Costa Rica, is í an t-oibreoir íocaíochta do Goldkey Technologies Limitada, ag gníomhú mar ghníomhaire íocaíochta thar ceann Goldkey Technologies Limitada. Tá GOLD SYNG INC.TECH LTD corpraithe agus eagraithe go cuí i bPoblacht na Cipire, faoi Uimhir Chláraithe na Cuideachta HE456057 ",
    // | FORM TRANSLATIONS
    backBtn: "Ar ais",
    closeBtn: "Dún",
    // | Step 1
  ...
  lb: {
    ...
    footerText:
      "Goldbet.io gehéiert a gëtt bedriwwen vun Goldkey Technologies Limitada. Registréierungsnummer: 3-102-892568, registréiert Adress: Puntarenas - Pastor Diaz ave. Provënz Puntarenas, Jaco, 61101, Costa Rica. Kontaktéiert eis op hello@goldbet.io. Goldbet.io ass lizenzéiert a reguléiert vun der Regierung vun der Autonomer Insel Anjouan, Unioun vun de Komoren a funktionéiert ënner Lizenz Nr. ALSI-012401005-F11. Goldbet.io huet all reglementaresch Ufuerderunge erfëllt an ass gesetzlech autoriséiert fir Spilloperatiounen fir all Glécksspiller a Wetten duerchzeféieren. Denkt drun datt Spillen süchteg ka sinn. Spillt verantwortlech. Goldbet.io akzeptéiert nëmme Clienten déi 18 Joer oder méi al sinn am Aklang mat Ärer Juridictioun. Goldkey Technologies Limitada, Registréierungsnummer 3-102-892568, eng Firma déi no de Gesetzer vu Costa Rica organiséiert an bedriwwe gëtt, ass den Bezuelungsoperateur vu Goldkey Technologies Limitada an handelt als Bezuelungsagent am Numm vu Goldkey Technologies Limitada. GOLD SYNG INC.TECH LTD ass richteg gegrënnt an organiséiert an der Republik Zypern, ënner Firmenregistréierungsnummer HE456057 ",
    // | FORM TRANSLATIONS
    backBtn: "Zréck",
    closeBtn: "Zoumaachen",
    // | Step 1
  ...
  mt: {
    ...
    footerText:
      "Goldbet.io huwa proprjetà u operat minn Goldkey Technologies Limitada. Numru ta’ reġistrazzjoni: 3-102-892568, indirizz irreġistrat: Puntarenas - Pastor Diaz ave. Puntarenas Province, Jaco, 61101, Costa Rica. Ikkuntattjana fuq hello@goldbet.io. Goldbet.io huwa liċenzjat u rregolat mill-Gvern tal-Gżira Awtonoma ta’ Anjouan, Unjoni tal-Komoros u jopera taħt Liċenzja Nru. ALSI-012401005-F11. Goldbet.io għadda mir-rekwiżiti kollha ta’ konformità regolatorja u huwa awtorizzat legalment biex iwettaq operazzjonijiet tal-logħob għal kull tip ta’ logħob tal-ażżard u mħatri. Ftakar li l-logħob tal-ażżard jista’ jkun vizzjuż. Ilgħab b’mod responsabbli. Goldbet.io jaċċetta biss klijenti li għandhom 18-il sena jew aktar skont il-ġurisdizzjoni tiegħek. Goldkey Technologies Limitada, numru ta’ reġistrazzjoni 3-102-892568, kumpanija organizzata u operata taħt il-liġijiet tal-Costa Rica, hija l-operatur tal-ħlas ta’ Goldkey Technologies Limitada, li taġixxi bħala aġent tal-ħlas f’isem Goldkey Technologies Limitada. GOLD SYNG INC.TECH LTD hija inkorporata u organizzata kif suppost fir-Repubblika ta’ Ċipru, taħt in-Numru ta’ Reġistrazzjoni tal-Kumpanija HE456057 ",
    // | FORM TRANSLATIONS
    backBtn: "Lura",
    closeBtn: "Agħlaq",
    // | Step 1
