...
- Sei responsabile delle eventuali tasse sulle criptovalute ricevute tramite i Servizi.`,
  ...
  ha: {
    ...
    advantege1Title: "VPN Aboki",
    advantege1Text: "Zaka iya amfani da VPN don shiga dandalinmu cikin sauƙi.",
    advantege2Title: "Babu KYC da Ake Buƙata",
    advantege2Text:
      "Babu tabbatarwar KYC da ake buƙata don ajiya da cirewa na crypto.",
    advantege3Title: "Kyautar Kira 25%",
    advantege3Text: "Gayyaci 'yan wasa kuma sami 25% na kudin shiga casino.",
    footerText:
    ...
    // | Form
    signUpTitle: "Yi Rajista",
    emailPlaceholder: "E-mail",
    wrongEmail: "E-mail ba daidai ba",
    wrongPassword: "Aƙalla haruffa 6.",
    passwordPlaceholder: "Kalmar sirri",
    yourCurrency: "Kuɗin ka",
    startPlaying: "Fara Wasa",
    terms: `Na yarda da <span class="text-white underline underline-offset-4">Sharuɗɗa da Yanayi</span>`,
    signUpWithGoogle: "Yi Rajista da Google",
    signUpWithFacebook: "Yi Rajista da Facebook",
    signUpWithTelegram: "Yi Rajista da Telegram",
    // | Terms
  ...
  yo: {
    ...
    advantege1Title: "VPN Ọrẹ",
    advantege1Text: "O le lo VPN lati wọle si pẹpẹ wa ni irọrun.",
    advantege2Title: "KYC Ko Nilo",
    advantege2Text:
      "Ko si ìfọwọ́sí KYC ti a nilo fun awọn ifipamọ ati yiyọkuro crypto.",
    advantege3Title: "Ẹbun Itọkasi 25%",
    advantege3Text: "Pe awọn oṣere ki o gba 25% ti owo-wiwọle kasino.",
    footerText:
    ...
    // | Form
    signUpTitle: "Forukọsilẹ",
    emailPlaceholder: "E-mail",
    wrongEmail: "E-mail ti ko tọ",
    wrongPassword: "O kere ju awọn ohun kikọ 6.",
    passwordPlaceholder: "Ọrọ aṣina",
    yourCurrency: "Owo-ori rẹ",
    startPlaying: "Bẹrẹ Ṣere",
    terms: `Mo gba pẹlu <span class="text-white underline underline-offset-4">Awọn Ofin ati Ipo</span>`,
    signUpWithGoogle: "Forukọsilẹ pẹlu Google",
    signUpWithFacebook: "Forukọsilẹ pẹlu Facebook",
    signUpWithTelegram: "Forukọsilẹ pẹlu Telegram",
    // | Terms
  ...
  ig: {
    ...
    advantege1Title: "VPN Enyi",
    advantege1Text: "Ị nwere ike iji VPN ịnweta ikpo okwu anyị n'ụzọ dị mfe.",
    advantege2Title: "Achọghị KYC",
    advantege2Text: "Achọghị nkwenye KYC maka ntinye na iwepu crypto.",
    advantege3Title: "Ụgwọ Ntụ 25%",
    advantege3Text: "Kpọọ ndị na-egwu egwu ma nweta 25% nke ego casino.",
    footerText:
    ...
    // | Form
    signUpTitle: "Debanye Aha",
    emailPlaceholder: "E-mail",
    wrongEmail: "E-mail ezighi ezi",
    wrongPassword: "Opekata mpe mkpụrụ asụsụ 6.",
    passwordPlaceholder: "Okwuntughe",
    yourCurrency: "Ego gị",
    startPlaying: "Bido Egwu",
    terms: `Ekwenyere m na <span class="text-white underline underline-offset-4">Usoro na Ọnọdụ</span>`,
    signUpWithGoogle: "Debanye Aha na Google",
    signUpWithFacebook: "Debanye Aha na Facebook",
    signUpWithTelegram: "Debanye Aha na Telegram",
    // | Terms
  ...
  tw: {
    ...
    advantege1Title: "VPN Adamfo",
    advantege1Text: "Wobetumi de VPN kɔ yɛn platform no so ntɛm ntɛm.",
    advantege2Title: "Ehia KYC Biara",
    advantege2Text: "Ehia KYC nsiesie biara mma crypto deposit ne withdrawal.",
    advantege3Title: "Referral Bonus 25%",
    advantege3Text: "Frɛ nnipa na nya casino asɛde a ɛyɛ 25%.",
    footerText:
    ...
    // | Form
    signUpTitle: "Kyerɛw Wo Ho",
    emailPlaceholder: "E-mail",
    wrongEmail: "E-mail bɔne",
    wrongPassword: "Nkyerɛwee 6 nkorɔfo ankorɔfo.",
    passwordPlaceholder: "Gyinae-nsɛm",
    yourCurrency: "Wo sika",
    startPlaying: "Hyɛ Agoro No Ase",
    terms: `Meagree na <span class="text-white underline underline-offset-4">Mmara ne Nneyɛe</span>`,
    signUpWithGoogle: "Kyerɛw Wo Ho ne Google",
    signUpWithFacebook: "Kyerɛw Wo Ho ne Facebook",
    signUpWithTelegram: "Kyerɛw Wo Ho ne Telegram",
    // | Terms
