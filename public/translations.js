export const translations = {
  ...
  ua: {
    ...
    footerText: `<span class="current-domain"></span> — це інформаційна платформа про бонуси та акції в онлайн-казино. Уся надана інформація призначена лише для ознайомлення та розваг. Умови бонусів можуть змінюватися без попередження, і <span class="current-domain"></span> не несе відповідальності за будь-які розбіжності. Пропозиції доступні лише особам віком від 18 років, які є резидентами дозволених юрисдикцій. Перед реєстрацією або отриманням будь-якого бонусу уважно ознайомтесь з умовами кожного казино. Грайте відповідально!`,
    // | FORM TRANSLATIONS
    backBtn: "Назад",
    closeBtn: "Закрити",
    // | Step 1
  ...
  kz: {
    ...
    heroTitle: `бонусыңызды алыңыз <br/> <span><i class="actual-spin-amount">100</i> тегін айналдыру</span> <br/> <span>big bass splash</span> ойынында`,
    heroSubtitle: `+<span class="two-step-bonus-percent"></span> дейін <span class='bonus-total-amount'></span> <span class='bonus-currency-symbol'></span> және <span class="two-step-bonus-spins"></span> тегін айналдыру бірінші депозитпен`,
    heroBtn: "бонус алу",
    slideStep1Title: "Тіркелу",
    slideStep1Text: '"Бонус алу" түймесін басып, тегін тіркеуден өтіңіз.',
    slideStep2Title: "Бонусыңызды белсендіріңіз",
    slideStep2Text:
      '"Бонус орталығынан" бонусты тауып, ойынды бастау үшін оны белсендіріңіз.',
    slideStep3Title: "Ойнаңыз",
    slideStep3Text: "Қаражат енді ойнауға қолжетімді. Ләззат алыңыз!",
    footerText: `<span class="current-domain"></span> — онлайн-казинолардағы бонустар мен акциялар туралы ақпараттық платформа. Барлық ақпарат тек ақпараттық және ойын-сауық мақсатында берілген. Бонус шарттары ескертусіз өзгеруі мүмкін, және <span class="current-domain"></span> кез келген айырмашылықтар үшін жауапты емес. Ұсыныстар тек 18 жастан асқан және рұқсат етілген юрисдикциялардың тұрғындарына қолжетімді. Тіркелмес бұрын немесе бонусты талап етпес бұрын, әр казиноның шарттарымен мұқият танысыңыз. Жауапкершілікпен ойнаңыз!`,
    // | FORM TRANSLATIONS
    backBtn: "Артқа",
    closeBtn: "Жабу",
    // | Step 1
    ...
    // | Step 2
    step2Title: "Электронды поштаңызды енгізіңіз",
    ...
    zipCodePlaceholder: "Пошталық индекс енгізіңіз",
    createAccountBtn: "Тіркелгі жасау",
    // | Decline
    areYouSure: `Сіз сенімдісіз бе? <br /> Прогрессіңіз жойылады`,
    keepRegistering: "Тіркеуді жалғастыру",
    returnToWebsite: "Веб-сайтқа оралу",
  },
  dk: {
