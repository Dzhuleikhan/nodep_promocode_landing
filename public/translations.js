export const translations = {
  ...
  bg: {
    ...
    footerText:
      "Goldbet.io е собственост и се управлява от Goldkey Technologies Limitada. Регистрационен номер: 3-102-892568, регистриран адрес: Puntarenas - Pastor Diaz ave. Провинция Пунтаренас, Хако, 61101, Коста Рика. Свържете се с нас на hello@goldbet.io. Goldbet.io е лицензиран и регулиран от Правителството на автономния остров Анжуан, Съюз на Коморските острови и оперира под лиценз № ALSI-012401005-F11. Goldbet.io е преминал всички регулаторни проверки и е законно упълномощен да извършва хазартни дейности за всички видове игри на късмета и залагания. Помнете, че хазартът може да доведе до зависимост. Играйте отговорно. Goldbet.io приема само клиенти на възраст 18 или повече години в съответствие с вашата юрисдикция. Goldkey Technologies Limitada, регистрационен номер 3-102-892568, компания, създадена и управлявана съгласно законите на Коста Рика, е платежният оператор на Goldkey Technologies Limitada, действащ като платежен агент от името на Goldkey Technologies Limitada. GOLD SYNG INC.TECH LTD е надлежно учредена и организирана в Република Кипър, под регистрационен номер на компанията HE456057 ",
    // | FORM TRANSLATIONS
    backBtn: "Назад",
    closeBtn: "Затвори",
    // | Step 1
  ...
  da: {
    ...
    footerText:
      "Goldbet.io ejes og drives af Goldkey Technologies Limitada. Registreringsnummer: 3-102-892568, registreret adresse: Puntarenas - Pastor Diaz ave. Puntarenas-provinsen, Jaco, 61101, Costa Rica. Kontakt os på hello@goldbet.io. Goldbet.io er licenseret og reguleret af regeringen på den autonome ø Anjouan, Unionen af Comorerne og opererer under licens nr. ALSI-012401005-F11. Goldbet.io har bestået alle lovmæssige krav og er juridisk autoriseret til at drive spilaktiviteter for alle typer hasardspil og væddemål. Husk, at spil kan være vanedannende. Spil ansvarligt. Goldbet.io accepterer kun kunder, der er 18 år eller ældre i overensstemmelse med din jurisdiktion. Goldkey Technologies Limitada, registreringsnummer 3-102-892568, et selskab organiseret og drevet i henhold til Costa Ricas lovgivning, er betalingsoperatør for Goldkey Technologies Limitada og fungerer som betalingsagent på vegne af Goldkey Technologies Limitada. GOLD SYNG INC.TECH LTD er behørigt stiftet og organiseret i Republikken Cypern under selskabsregistreringsnummer HE456057 ",
    // | FORM TRANSLATIONS
    backBtn: "Tilbage",
    closeBtn: "Luk",
    // | Step 1
  ...
  nl: {
    ...
    footerText:
      "Goldbet.io is eigendom van en wordt beheerd door Goldkey Technologies Limitada. Registratienummer: 3-102-892568, geregistreerd adres: Puntarenas - Pastor Diaz ave. Provincie Puntarenas, Jaco, 61101, Costa Rica. Neem contact met ons op via hello@goldbet.io. Goldbet.io is gelicentieerd en gereguleerd door de regering van het autonome eiland Anjouan, Unie van de Comoren en opereert onder licentienummer ALSI-012401005-F11. Goldbet.io heeft alle wettelijke controles doorstaan en is wettelijk gemachtigd om kansspelen en weddenschappen te exploiteren. Onthoud dat gokken verslavend kan zijn. Speel verantwoord. Goldbet.io accepteert alleen klanten van 18 jaar en ouder in overeenstemming met uw jurisdictie. Goldkey Technologies Limitada, registratienummer 3-102-892568, een bedrijf opgericht en beheerd volgens de wetten van Costa Rica, is de betalingsoperator van Goldkey Technologies Limitada en treedt op als betalingsagent namens Goldkey Technologies Limitada. GOLD SYNG INC.TECH LTD is naar behoren opgericht en georganiseerd in de Republiek Cyprus onder bedrijfsregistratienummer HE456057 ",
    // | FORM TRANSLATIONS
    backBtn: "Terug",
    closeBtn: "Sluiten",
    // | Step 1
    ...
    footerText:
      "Goldbet.io on Goldkey Technologies Limitada -yhtiön omistama ja ylläpitämä. Rekisterinumero: 3-102-892568, rekisteröity osoite: Puntarenas - Pastor Diaz ave. Puntarenasin provinssi, Jaco, 61101, Costa Rica. Ota yhteyttä: hello@goldbet.io. Goldbet.io on lisensoitu ja säännelty Anjouanin autonomisen saaren hallituksen toimesta, Komorien liitto, ja toimii lisenssillä nro ALSI-012401005-F11. Goldbet.io on läpäissyt kaikki sääntelyvaatimukset ja on laillisesti valtuutettu harjoittamaan rahapelitoimintaa kaikissa onnenpeleissä ja vedonlyönnissä. Muista, että rahapelaaminen voi aiheuttaa riippuvuutta. Pelaa vastuullisesti. Goldbet.io hyväksyy vain 18 vuotta täyttäneet asiakkaat oman lainkäyttöalueesi mukaisesti. Goldkey Technologies Limitada, rekisterinumero 3-102-892568, Costa Rican lakien mukaisesti perustettu ja toimiva yritys, toimii Goldkey Technologies Limitadan maksunvälittäjänä ja maksuedustajana. GOLD SYNG INC.TECH LTD on asianmukaisesti perustettu ja organisoitu Kyproksen tasavallassa yritysrekisterinumerolla HE456057 ",
    // | FORM TRANSLATIONS
    backBtn: "Takaisin",
    closeBtn: "Sulje",
    // | Step 1
  ...
  uk: {
    ...
    footerText:
      "Goldbet.io належить та управляється компанією Goldkey Technologies Limitada. Реєстраційний номер: 3-102-892568, зареєстрована адреса: Puntarenas - Pastor Diaz ave. Провінція Пунтаренас, Хако, 61101, Коста-Рика. Зв'яжіться з нами: hello@goldbet.io. Goldbet.io ліцензований та регулюється урядом автономного острова Анжуан, Союз Коморських Островів, та працює за ліцензією № ALSI-012401005-F11. Goldbet.io пройшов усі регуляторні перевірки та має законне право здійснювати гральну діяльність для всіх видів азартних ігор та ставок. Пам'ятайте, що азартні ігри можуть викликати залежність. Грайте відповідально. Goldbet.io приймає лише клієнтів віком від 18 років відповідно до вашої юрисдикції. Goldkey Technologies Limitada, реєстраційний номер 3-102-892568, компанія, створена та керована відповідно до законів Коста-Рики, є платіжним оператором Goldkey Technologies Limitada та виступає як платіжний агент від імені Goldkey Technologies Limitada. GOLD SYNG INC.TECH LTD належним чином зареєстрована та організована в Республіці Кіпр під реєстраційним номером компанії HE456057 ",
    // | FORM TRANSLATIONS
    backBtn: "Назад",
    closeBtn: "Закрити",
    // | Step 1
  ...
  zh: {
    ...
    footerText:
      "Goldbet.io 由 Goldkey Technologies Limitada 拥有并运营。注册号：3-102-892568，注册地址：Puntarenas - Pastor Diaz ave. Puntarenas 省，Jaco，61101，哥斯达黎加。联系我们：hello@goldbet.io。Goldbet.io 由科摩罗联盟安儒昂自治岛政府许可并监管，许可证编号：ALSI-012401005-F11。Goldbet.io 已通过所有监管合规检查，并被合法授权开展所有形式的博彩和投注业务。请记住，赌博可能会上瘾。请理性游戏。Goldbet.io 仅接受年满 18 岁的客户，具体以您所在司法辖区为准。Goldkey Technologies Limitada（注册号 3-102-892568）是一家根据哥斯达黎加法律成立并运营的公司，作为 Goldkey Technologies Limitada 的支付运营商，并代表其作为支付代理。GOLD SYNG INC.TECH LTD 已在塞浦路斯共和国正式注册成立，公司注册号为 HE456057 ",
    // | FORM TRANSLATIONS
    backBtn: "返回",
    closeBtn: "关闭",
    // | Step 1
  ...
  ga: {
    ...
    footerText:
      "Is le Goldkey Technologies Limitada Goldbet.io agus tá sé á oibriú acu. Uimhir chlárúcháin: 3-102-892568, seoladh cláraithe: Puntarenas - Pastor Diaz ave. Cúige Puntarenas, Jaco, 61101, Costa Rica. Déan teagmháil linn ag hello@goldbet.io. Tá Goldbet.io ceadúnaithe agus rialaithe ag Rialtas Oileán Uathrialach Anjouan, Aontas na gComóraí, agus oibríonn sé faoi cheadúnas Uimh. ALSI-012401005-F11. Tá Goldbet.io tar éis gach riachtanas comhlíonta rialála a chomhlíonadh agus tá sé údaraithe go dleathach gníomhaíochtaí cearrbhachais a dhéanamh do gach cineál cluichí seans agus gealltóireachta. Cuimhnigh gur féidir le cearrbhachas a bheith andúileach. Imir go freagrach. Ní ghlacann Goldbet.io ach le custaiméirí atá 18 mbliana d’aois nó níos sine de réir do dhlínse. Goldkey Technologies Limitada, uimhir chlárúcháin 3-102-892568, cuideachta a bunaíodh agus a oibrítear faoi dhlí Costa Rica, is é an t-oibreoir íocaíochta do Goldkey Technologies Limitada é agus feidhmíonn sé mar ghníomhaire íocaíochta thar ceann Goldkey Technologies Limitada. Tá GOLD SYNG INC.TECH LTD corpraithe agus eagraithe go cuí i bPoblacht na Cipire faoi Uimhir Chláraithe Cuideachta HE456057 ",
    // | FORM TRANSLATIONS
    backBtn: "Ar ais",
    closeBtn: "Dún",
    // | Step 1
  ...
  lb: {
    ...
    footerText:
      "Goldbet.io gehéiert a gëtt bedriwwe vu Goldkey Technologies Limitada. Registréierungsnummer: 3-102-892568, registréiert Adress: Puntarenas - Pastor Diaz ave. Provënz Puntarenas, Jaco, 61101, Costa Rica. Kontaktéiert eis op hello@goldbet.io. Goldbet.io ass lizenzéiert a reglementéiert vun der Regierung vun der autonomer Insel Anjouan, Unioun vun de Komoren, a funktionéiert ënner Lizenz Nr. ALSI-012401005-F11. Goldbet.io huet all reglementaresch Ufuerderunge erfëllt an ass gesetzlech autoriséiert fir Glécksspiller an Wetten unzebidden. Denkt drun datt Spillen süchteg ka sinn. Spillt verantwortlech. Goldbet.io akzeptéiert nëmme Clienten ab 18 Joer oder méi al am Aklang mat Ärer Juridictioun. Goldkey Technologies Limitada, Registréierungsnummer 3-102-892568, eng Firma déi no de Gesetzer vu Costa Rica organiséiert a bedriwwe gëtt, ass de Bezuelungsoperateur vu Goldkey Technologies Limitada a handelt als Bezuelungsagent am Numm vu Goldkey Technologies Limitada. GOLD SYNG INC.TECH LTD ass ordnungsgeméiss an der Republik Zypern gegrënnt an organiséiert ënner Firmenregistréierungsnummer HE456057 ",
    // | FORM TRANSLATIONS
    backBtn: "Zréck",
    closeBtn: "Zoumaachen",
    // | Step 1
  ...
  mt: {
    ...
    footerText:
      "Goldbet.io hija proprjetà ta' u operata minn Goldkey Technologies Limitada. Numru ta' reġistrazzjoni: 3-102-892568, indirizz irreġistrat: Puntarenas - Pastor Diaz ave. Provinċja ta' Puntarenas, Jaco, 61101, Costa Rica. Ikkuntattjana fuq hello@goldbet.io. Goldbet.io hija liċenzjata u regolata mill-Gvern tal-Gżira Awtonoma ta' Anjouan, Unjoni tal-Komoros u topera taħt Liċenzja Nru ALSI-012401005-F11. Goldbet.io għaddiet minn kull konformità regolatorja u hija awtorizzata legalment biex twettaq operazzjonijiet ta' logħob għal kull tip ta' logħob ta' xorti u mħatri. Ftakar li l-logħob jista' jkun vizzju. Ilgħab b'mod responsabbli. Goldbet.io taċċetta biss klijenti li għandhom 18-il sena jew aktar skont il-ġurisdizzjoni tiegħek. Goldkey Technologies Limitada, numru ta' reġistrazzjoni 3-102-892568, kumpanija organizzata u operata skont il-liġi ta' Costa Rica, hija l-operatur tal-pagamenti ta' Goldkey Technologies Limitada u taġixxi bħala aġent tal-pagamenti f'isem Goldkey Technologies Limitada. GOLD SYNG INC.TECH LTD hija inkorporata u organizzata kif suppost fir-Repubblika ta' Ċipru taħt in-numru ta' reġistrazzjoni tal-kumpanija HE456057 ",
    // | FORM TRANSLATIONS
    backBtn: "Lura",
    closeBtn: "Agħlaq",
    // | Step 1
