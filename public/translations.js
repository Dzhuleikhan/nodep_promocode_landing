export const translations = {
  ...
  fr: {
    ...
    heroTitle: `Réclamez un bonus <br/> <span>de 100 tours gratuits</span> <br/> dans <span>the dog house</span>.`,
  ...
  ro: {
    ...
    heroTitle: `reivindică-ți bonusul <br/> <span>100 rotiri gratuite</span> <br/> în <span>the dog house</span>`,
  ...
  hu: {
    ...
    heroTitle: `igényeld a bónuszod <br/> <span>100 ingyenes pörgetés</span> <br/> a <span>the dog house</span> játékban`,
  ...
  pl: {
    ...
    heroTitle:
      "odebrój swój bonus <br/> <span>100 darmowych spinów</span> <br/> w <span>the dog house</span>",
  ...
  cz: {
    ...
    heroTitle:
      "získejte svůj bonus <br/> <span>100 volných točení</span> <br/> ve hře <span>the dog house</span>",
  ...
  si: {
    ...
    heroTitle:
      "prevzemite svoj bonus <br/> <span>100 brezplačnih vrtljajev</span> <br/> v <span>the dog house</span>",
  ...
  gr: {
    ...
    heroTitle: `διεκδικήστε το μπόνους σας <br/> <span>100 δωρεάν περιστροφές</span> <br/> στο <span>the dog house</span>`,
  ...
  no: {
    ...
    heroTitle: `kreve din bonus <br/> <span>100 gratisspinn</span> <br/> i <span>the dog house</span>`,
  ...
  se: {
    ...
    heroTitle: `hämta din bonus <br/> <span>100 gratissnurr</span> <br/> i <span>the dog house</span>`,
  ...
  sk: {
    ...
    heroTitle: `získajte svoj bonus <br/> <span>100 voľných spinov</span> <br/> v <span>the dog house</span>`,
  ...
  ru: {
    ...
    heroTitle: `заберите свой бонус <br/> <span>100 фриспинов</span> <br/> в <span>the dog house</span>`,
  ...
  es: {
    ...
    heroTitle: `reclama tu bono <br/> <span>100 giros gratis</span> <br/> en <span>the dog house</span>`,
  ...
  de: {
    ...
    heroTitle: `sichere dir deinen bonus <br/> <span>100 Freispiele</span> <br/> in <span>the dog house</span>`,
